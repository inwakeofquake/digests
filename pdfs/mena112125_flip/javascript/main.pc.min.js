...
bookConfig.ToolBarVisible?(this.topRightBar.append(this.topRightButton),this.onResize()):this.parent.append(this.topRightButton))},removeTopRightButton:function(){this.topRightButton&&(this.topRightButton.remove(),this.topRightButton=null)},onResize:function(a,b){var c=this,d,e,f,g,h,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(1==k.nextAddress)return bookConfig.ToolBarVisible?k.yield(new Promise(function(n){return requestAnimationFrame(n)}),2):k.return();a=void 0==a?c.parent.width():
parseInt(a);b=void 0==b?c.parent.height():parseInt(b);d=a/4;e=a/4;f=a-d-e;g=c.edtPageWidth+150+20;f<g&&(f=g,d=(a-f)/2);h=c.logoBar.find("img").height()+10;(m=null==(l=BookInfo)?void 0:l.top())&&c.isShowLogo&&m<h&&(bookConfig.topMargin=h,BookInfo.getBook().adjustBookPosition());c.buttonBarWidth=f;c.resetButtonPosition();k.jumpToEnd()})},afterButtonClick:function(a){this.extendedBar.visible&&"btnSocialShare"!=a.language.key&&(a!=this.btnMore?isPhone()||isPad()||this.extendedBar.hide():(a=this.buttonsInExtendedBar(),
