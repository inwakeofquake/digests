...
h.callWhenSettled_(k.resolve,k.reject)};f.prototype.settleSameAsThenable_=function(h,k){var l=this.createResolveAndReject_();try{h.call(k,l.resolve,l.reject)}catch(m){l.reject(m)}};f.prototype.then=function(h,k){function l(x,t){return"function"==typeof x?function(r){try{m(x(r))}catch(u){q(u)}}:t}var m,q,p=new f(function(x,t){m=x;q=t});this.callWhenSettled_(l(h,m),l(k,q));return p};f.prototype.catch=function(h){return this.then(void 0,h)};f.prototype.callWhenSettled_=function(h,k){function l(){switch(m.state_){case 1:h(m.result_);
...
q){function p(r){return function(u){x[r]=u;t--;0==t&&m(x)}}var x=[],t=0;do x.push(void 0),t++,d(l.value).callWhenSettled_(p(x.length-1),q),l=k.next();while(!l.done)})};return f},"es6","es3");$jscomp.iteratorFromArray=function(b,c){b instanceof String&&(b+="");var d=0,e=!1,f={next:function(){if(!e&&d<b.length){var g=d++;return{value:c(g,b[g]),done:!1}}e=!0;return{done:!0,value:void 0}}};f[Symbol.iterator]=function(){return f};return f};
...
(function(b,c,d,e){function f(n,v,w){return setTimeout(m(n,w),v)}function g(n,v,w){return Array.isArray(n)?(h(n,w[v],w),!0):!1}function h(n,v,w){var B;if(n)if(n.forEach)n.forEach(v,w);else if(n.length!==e)for(B=0;B<n.length;)v.call(w,n[B],B,n),B++;else for(B in n)n.hasOwnProperty(B)&&v.call(w,n[B],B,n)}function k(n,v,w){var B="DEPRECATED METHOD: "+v+"\n"+w+" AT \n";return function(){var C=Error("get-stack-trace");C=C&&C.stack?C.stack.replace(/^[^\(]+?[\n$]/gm,"").replace(/^\s+at\s+/gm,"").replace(/^Object.<anonymous>\s*\(/gm,
"{anonymous}()@"):"Unknown Stack Trace";var E=b.console&&(b.console.warn||b.console.log);E&&E.call(b.console,B,C);return n.apply(this,arguments)}}function l(n,v,w){v=v.prototype;var B=n.prototype=Object.create(v);B.constructor=n;B._super=v;w&&Y(B,w)}function m(n,v){return function(){return n.apply(v,arguments)}}function q(n,v){return"function"==typeof n?n.apply(v?v[0]||e:e,v):n}function p(n,v,w){h(r(v),function(B){"undefined"!=typeof b.addEventListener?n.addEventListener(B,w,!1):n.attachEvent(B,w)})}
function x(n,v,w){h(r(v),function(B){"undefined"!=typeof b.removeEventListener?n.removeEventListener(B,w,!1):n.detachEvent(B,w,!1)})}function t(n,v){for(;n;){if(n==v)return!0;n=n.parentNode}return!1}function r(n){return n.trim().split(/\s+/g)}function u(n,v,w){if(n.indexOf&&!w)return n.indexOf(v);for(var B=0;B<n.length;){if(w&&n[B][w]==v||!w&&n[B]===v)return B;B++}return-1}function y(n){return Array.prototype.slice.call(n,0)}function z(n,v,w){for(var B=[],C=[],E=0;E<n.length;){var G=v?n[E][v]:n[E];
0>u(C,G)&&B.push(n[E]);C[E]=G;E++}w&&(B=v?B.sort(function(L,U){return L[v]>U[v]}):B.sort());return B}function A(n,v){if(v&&v[0]){for(var w,B=v[0].toUpperCase()+v.slice(1),C=0;C<sa.length;){w=(w=sa[C])?w+B:v;if(w in n)return w;C++}return e}}function F(n){n=n.ownerDocument||n;return n.defaultView||n.parentWindow||b}function D(n,v){var w=this;this.manager=n;this.callback=v;this.element=n.element;this.target=n.options.inputTarget;this.domHandler=function(B){q(n.options.enable,[n])&&w.handler(B)};this.init()}
function M(n,v,w){var B=w.pointers.length,C=w.changedPointers.length;var E=v&1&&0===B-C;w.isFirst=!!E;w.isFinal=!!(v&12&&0===B-C);E&&(n.session={});w.eventType=v;v=n.session;B=w.pointers;C=B.length;v.firstInput||(v.firstInput=K(w));1<C&&!v.firstMultiple?v.firstMultiple=K(w):1===C&&(v.firstMultiple=!1);E=v.firstInput;var G=(C=v.firstMultiple)?C.center:E.center;var L=w.center=H(B);w.timeStamp=qa();w.deltaTime=w.timeStamp-E.timeStamp;w.angle=J(G,L);w.distance=N(G,L);E=w.center;G=v.offsetDelta||{};L=
v.prevDelta||{};var U=v.prevInput||{};if(1===w.eventType||4===U.eventType)L=v.prevDelta={x:U.deltaX||0,y:U.deltaY||0},G=v.offsetDelta={x:E.x,y:E.y};w.deltaX=L.x+(E.x-G.x);w.deltaY=L.y+(E.y-G.y);w.offsetDirection=I(w.deltaX,w.deltaY);G=w.deltaTime;E=w.deltaX/G||0;G=w.deltaY/G||0;w.overallVelocityX=E;w.overallVelocityY=G;w.overallVelocity=ba(E)>ba(G)?E:G;C?(E=C.pointers,E=N(B[0],B[1],na)/N(E[0],E[1],na)):E=1;w.scale=E;C?(C=C.pointers,B=J(B[1],B[0],na)+J(C[1],C[0],na)):B=0;w.rotation=B;w.maxPointers=
v.prevInput?w.pointers.length>v.prevInput.maxPointers?w.pointers.length:v.prevInput.maxPointers:w.pointers.length;G=v.lastInterval||w;B=w.timeStamp-G.timeStamp;8!=w.eventType&&(25<B||G.velocity===e)?(E=w.deltaX-G.deltaX,G=w.deltaY-G.deltaY,L=E/B||0,U=G/B||0,B=L,C=U,L=ba(L)>ba(U)?L:U,E=I(E,G),v.lastInterval=w):(L=G.velocity,B=G.velocityX,C=G.velocityY,E=G.direction);w.velocity=L;w.velocityX=B;w.velocityY=C;w.direction=E;v=n.element;t(w.srcEvent.target,v)&&(v=w.srcEvent.target);w.target=v;n.emit("hammer.input",
w);n.recognize(w);n.session.prevInput=w}function K(n){for(var v=[],w=0;w<n.pointers.length;)v[w]={clientX:ha(n.pointers[w].clientX),clientY:ha(n.pointers[w].clientY)},w++;return{timeStamp:qa(),pointers:v,center:H(v),deltaX:n.deltaX,deltaY:n.deltaY}}function H(n){var v=n.length;if(1===v)return{x:ha(n[0].clientX),y:ha(n[0].clientY)};for(var w=0,B=0,C=0;C<v;)w+=n[C].clientX,B+=n[C].clientY,C++;return{x:ha(w/v),y:ha(B/v)}}function I(n,v){return n===v?1:ba(n)>=ba(v)?0>n?2:4:0>v?8:16}function N(n,v,w){w||
(w=ta);var B=v[w[0]]-n[w[0]];n=v[w[1]]-n[w[1]];return Math.sqrt(B*B+n*n)}function J(n,v,w){w||(w=ta);return 180*Math.atan2(v[w[1]]-n[w[1]],v[w[0]]-n[w[0]])/Math.PI}function R(){this.evEl=Aa;this.evWin=Ba;this.pressed=!1;D.apply(this,arguments)}function ia(){this.evEl=ua;this.evWin=va;D.apply(this,arguments);this.store=this.manager.session.pointerEvents=[]}function ca(){this.evTarget="touchstart";this.evWin="touchstart touchmove touchend touchcancel";this.started=!1;D.apply(this,arguments)}function P(){this.evTarget=
Ca;this.targetIds={};D.apply(this,arguments)}function S(n,v){var w=y(n.touches),B=this.targetIds;if(v&3&&1===w.length)return B[w[0].identifier]=!0,[w,w];n=y(n.changedTouches);var C=[],E=this.target;var G=w.filter(function(L){return t(L.target,E)});if(1===v)for(w=0;w<G.length;)B[G[w].identifier]=!0,w++;for(w=0;w<n.length;)B[n[w].identifier]&&C.push(n[w]),v&12&&delete B[n[w].identifier],w++;if(C.length)return[z(G.concat(C),"identifier",!0),C]}function T(){D.apply(this,arguments);var n=m(this.handler,
this);this.touch=new P(this.manager,n);this.mouse=new R(this.manager,n);this.primaryTouch=null;this.lastTouches=[]}function ja(n){n=n.changedPointers[0];if(n.identifier===this.primaryTouch){var v={x:n.clientX,y:n.clientY};this.lastTouches.push(v);var w=this.lastTouches;setTimeout(function(){var B=w.indexOf(v);-1<B&&w.splice(B,1)},2500)}}function da(n,v){this.manager=n;this.set(v)}function V(n){if(-1<n.indexOf("none"))return"none";var v=-1<n.indexOf("pan-x"),w=-1<n.indexOf("pan-y");return v&&w?"none":
v||w?v?"pan-x":"pan-y":-1<n.indexOf("manipulation")?"manipulation":"auto"}function Q(n){this.options=Y({},this.defaults,n||{});this.id=Da++;this.manager=null;n=this.options.enable;this.options.enable=n===e?!0:n;this.state=1;this.simultaneous={};this.requireFail=[]}function la(n){return n&16?"cancel":n&8?"end":n&4?"move":n&2?"start":""}function ka(n){return 16==n?"down":8==n?"up":2==n?"left":4==n?"right":""}function ea(n,v){return(v=v.manager)?v.get(n):n}function O(){Q.apply(this,arguments)}function fa(){O.apply(this,
arguments);this.pY=this.pX=null}function Z(){O.apply(this,arguments)}function W(){Q.apply(this,arguments);this._input=this._timer=null}function aa(){O.apply(this,arguments)}function ma(){O.apply(this,arguments)}function oa(){Q.apply(this,arguments);this.pCenter=this.pTime=!1;this._input=this._timer=null;this.count=0}function X(n,v){v=v||{};var w=v.recognizers;v.recognizers=w===e?X.defaults.preset:w;return new ra(n,v)}function ra(n,v){this.options=Y({},X.defaults,v||{});this.options.inputTarget=this.options.inputTarget||
n;this.handlers={};this.session={};this.recognizers=[];this.oldCssProps={};this.element=n;this.input=new T(this,M);this.touchAction=new da(this,this.options.touchAction);wa(this,!0);h(this.options.recognizers,function(w){var B=this.add(new w[0](w[1]));w[2]&&B.recognizeWith(w[2]);w[3]&&B.requireFailure(w[3])},this)}function wa(n,v){var w=n.element;if(w.style){var B;h(n.options.cssProps,function(C,E){B=A(w.style,E);v?(n.oldCssProps[B]=w.style[B],w.style[B]=C):w.style[B]=n.oldCssProps[B]||""});v||(n.oldCssProps=
{})}}function Ea(n,v){var w=c.createEvent("Event");w.initEvent(n,!0,!0);w.gesture=v;v.target.dispatchEvent(w)}var sa=" webkit Moz MS ms o".split(" "),Fa=c.createElement("div"),ha=Math.round,ba=Math.abs,qa=Date.now;var Y="function"!==typeof Object.assign?function(n){if(n===e||null===n)throw new TypeError("Cannot convert undefined or null to object");for(var v=Object(n),w=1;w<arguments.length;w++){var B=arguments[w];if(B!==e&&null!==B)for(var C in B)B.hasOwnProperty(C)&&(v[C]=B[C])}return v}:Object.assign;
var xa=k(function(n,v,w){for(var B=Object.keys(v),C=0;C<B.length;){if(!w||w&&n[B[C]]===e)n[B[C]]=v[B[C]];C++}return n},"extend","Use `assign`."),Ga=k(function(n,v){return xa(n,v,!0)},"merge","Use `assign`."),Da=1,Ha=/mobile|tablet|ip(ad|hone|od)|android/i,Ia="ontouchstart"in b;A(b,"PointerEvent");Ia&&Ha.test(navigator.userAgent);var ta=["x","y"],na=["clientX","clientY"];D.prototype={handler:function(){},init:function(){this.evEl&&p(this.element,this.evEl,this.domHandler);this.evTarget&&p(this.target,
this.evTarget,this.domHandler);this.evWin&&p(F(this.element),this.evWin,this.domHandler)},destroy:function(){this.evEl&&x(this.element,this.evEl,this.domHandler);this.evTarget&&x(this.target,this.evTarget,this.domHandler);this.evWin&&x(F(this.element),this.evWin,this.domHandler)}};var Ja={mousedown:1,mousemove:2,mouseup:4},Aa="mousedown",Ba="mousemove mouseup";l(R,D,{handler:function(n){var v=Ja[n.type];v&1&&0===n.button&&(this.pressed=!0);v&2&&1!==n.which&&(v=4);this.pressed&&(v&4&&(this.pressed=
!1),this.callback(this.manager,v,{pointers:[n],changedPointers:[n],pointerType:"mouse",srcEvent:n}))}});var Ka={pointerdown:1,pointermove:2,pointerup:4,pointercancel:8,pointerout:8},La={2:"touch",3:"pen",4:"mouse",5:"kinect"},ua="pointerdown",va="pointermove pointerup pointercancel";b.MSPointerEvent&&!b.PointerEvent&&(ua="MSPointerDown",va="MSPointerMove MSPointerUp MSPointerCancel");l(ia,D,{handler:function(n){var v=this.store,w=!1,B=n.type.toLowerCase().replace("ms","");B=Ka[B];var C=La[n.pointerType]||
n.pointerType,E="touch"==C,G=u(v,n.pointerId,"pointerId");B&1&&(0===n.button||E)?0>G&&(v.push(n),G=v.length-1):B&12&&(w=!0);0>G||(v[G]=n,this.callback(this.manager,B,{pointers:v,changedPointers:[n],pointerType:C,srcEvent:n}),w&&v.splice(G,1))}});var Ma={touchstart:1,touchmove:2,touchend:4,touchcancel:8};l(ca,D,{handler:function(n){var v=Ma[n.type];1===v&&(this.started=!0);if(this.started){var w=y(n.touches);var B=y(n.changedTouches);v&12&&(w=z(w.concat(B),"identifier",!0));w=[w,B];v&12&&0===w[0].length-
w[1].length&&(this.started=!1);this.callback(this.manager,v,{pointers:w[0],changedPointers:w[1],pointerType:"touch",srcEvent:n})}}});var Na={touchstart:1,touchmove:2,touchend:4,touchcancel:8},Ca="touchstart touchmove touchend touchcancel";l(P,D,{handler:function(n){var v=Na[n.type],w=S.call(this,n,v);w&&this.callback(this.manager,v,{pointers:w[0],changedPointers:w[1],pointerType:"touch",srcEvent:n})}});l(T,D,{handler:function(n,v,w){var B="mouse"==w.pointerType;if(!(B&&w.sourceCapabilities&&w.sourceCapabilities.firesTouchEvents)){if("touch"==
w.pointerType)v&1?(this.primaryTouch=w.changedPointers[0].identifier,ja.call(this,w)):v&12&&ja.call(this,w);else{if(B)a:{B=w.srcEvent.clientX;for(var C=w.srcEvent.clientY,E=0;E<this.lastTouches.length;E++){var G=this.lastTouches[E],L=Math.abs(C-G.y);if(25>=Math.abs(B-G.x)&&25>=L){B=!0;break a}}B=!1}if(B)return}this.callback(n,v,w)}},destroy:function(){this.touch.destroy();this.mouse.destroy()}});var ya=A(Fa.style,"touchAction"),za=ya!==e,pa=function(){if(!za)return!1;var n={},v=b.CSS&&b.CSS.supports;
"auto;manipulation;pan-y;pan-x;pan-x pan-y;none".split(";").forEach(function(w){n[w]=v?b.CSS.supports("touch-action",w):!0});return n}();da.prototype={set:function(n){"compute"==n&&(n=this.compute());za&&this.manager.element.style&&pa[n]&&(this.manager.element.style[ya]=n);this.actions=n.toLowerCase().trim()},update:function(){this.set(this.manager.options.touchAction)},compute:function(){var n=[];h(this.manager.recognizers,function(v){q(v.options.enable,[v])&&(n=n.concat(v.getTouchAction()))});return V(n.join(" "))},
preventDefaults:function(n){var v=n.srcEvent,w=n.offsetDirection;if(this.manager.session.prevented)v.preventDefault();else{var B=this.actions,C=-1<B.indexOf("none")&&!pa.none,E=-1<B.indexOf("pan-y")&&!pa["pan-y"];B=-1<B.indexOf("pan-x")&&!pa["pan-x"];if(C){var G=2>n.distance,L=250>n.deltaTime;if(1===n.pointers.length&&G&&L)return}if(!B||!E)if(C||E&&w&6||B&&w&24)return this.preventSrc(v)}},preventSrc:function(n){this.manager.session.prevented=!0;n.preventDefault()}};Q.prototype={defaults:{},set:function(n){Y(this.options,
n);this.manager&&this.manager.touchAction.update();return this},recognizeWith:function(n){if(g(n,"recognizeWith",this))return this;var v=this.simultaneous;n=ea(n,this);v[n.id]||(v[n.id]=n,n.recognizeWith(this));return this},dropRecognizeWith:function(n){if(g(n,"dropRecognizeWith",this))return this;n=ea(n,this);delete this.simultaneous[n.id];return this},requireFailure:function(n){if(g(n,"requireFailure",this))return this;var v=this.requireFail;n=ea(n,this);-1===u(v,n)&&(v.push(n),n.requireFailure(this));
return this},dropRequireFailure:function(n){if(g(n,"dropRequireFailure",this))return this;n=ea(n,this);n=u(this.requireFail,n);-1<n&&this.requireFail.splice(n,1);return this},hasRequireFailures:function(){return 0<this.requireFail.length},canRecognizeWith:function(n){return!!this.simultaneous[n.id]},emit:function(n){function v(C){w.manager.emit(C,n)}var w=this,B=this.state;8>B&&v(w.options.event+la(B));v(w.options.event);n.additionalEvent&&v(n.additionalEvent);8<=B&&v(w.options.event+la(B))},tryEmit:function(n){if(this.canEmit())return this.emit(n);
this.state=32},canEmit:function(){for(var n=0;n<this.requireFail.length;){if(!(this.requireFail[n].state&33))return!1;n++}return!0},recognize:function(n){n=Y({},n);q(this.options.enable,[this,n])?(this.state&56&&(this.state=1),this.state=this.process(n),this.state&30&&this.tryEmit(n)):(this.reset(),this.state=32)},process:function(n){},getTouchAction:function(){},reset:function(){}};l(O,Q,{defaults:{pointers:1},attrTest:function(n){var v=this.options.pointers;return 0===v||n.pointers.length===v},
process:function(n){var v=this.state,w=n.eventType,B=v&6;n=this.attrTest(n);return B&&(w&8||!n)?v|16:B||n?w&4?v|8:v&2?v|4:2:32}});l(fa,O,{defaults:{event:"pan",threshold:10,pointers:1,direction:30},getTouchAction:function(){var n=this.options.direction,v=[];n&6&&v.push("pan-y");n&24&&v.push("pan-x");return v},directionTest:function(n){var v=this.options,w=!0,B=n.distance,C=n.direction,E=n.deltaX,G=n.deltaY;C&v.direction||(v.direction&6?(C=0===E?1:0>E?2:4,w=E!=this.pX,B=Math.abs(n.deltaX)):(C=0===
G?1:0>G?8:16,w=G!=this.pY,B=Math.abs(n.deltaY)));n.direction=C;return w&&B>v.threshold&&C&v.direction},attrTest:function(n){return O.prototype.attrTest.call(this,n)&&(this.state&2||!(this.state&2)&&this.directionTest(n))},emit:function(n){this.pX=n.deltaX;this.pY=n.deltaY;var v=ka(n.direction);v&&(n.additionalEvent=this.options.event+v);this._super.emit.call(this,n)}});l(Z,O,{defaults:{event:"pinch",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,
n)&&(Math.abs(n.scale-1)>this.options.threshold||this.state&2)},emit:function(n){1!==n.scale&&(n.additionalEvent=this.options.event+(1>n.scale?"in":"out"));this._super.emit.call(this,n)}});l(W,Q,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(n){var v=this.options,w=n.pointers.length===v.pointers,B=n.distance<v.threshold,C=n.deltaTime>v.time;this._input=n;if(!B||!w||n.eventType&12&&!C)this.reset();else if(n.eventType&1)this.reset(),
this._timer=f(function(){this.state=8;this.tryEmit()},v.time,this);else if(n.eventType&4)return 8;return 32},reset:function(){clearTimeout(this._timer)},emit:function(n){8===this.state&&(n&&n.eventType&4?this.manager.emit(this.options.event+"up",n):(this._input.timeStamp=qa(),this.manager.emit(this.options.event,this._input)))}});l(aa,O,{defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return["none"]},attrTest:function(n){return this._super.attrTest.call(this,n)&&(Math.abs(n.rotation)>
this.options.threshold||this.state&2)}});l(ma,O,{defaults:{event:"swipe",threshold:10,velocity:.3,direction:30,pointers:1},getTouchAction:function(){return fa.prototype.getTouchAction.call(this)},attrTest:function(n){var v=this.options.direction;if(v&30)var w=n.overallVelocity;else v&6?w=n.overallVelocityX:v&24&&(w=n.overallVelocityY);return this._super.attrTest.call(this,n)&&v&n.offsetDirection&&n.distance>this.options.threshold&&n.maxPointers==this.options.pointers&&ba(w)>this.options.velocity&&
n.eventType&4},emit:function(n){var v=ka(n.offsetDirection);v&&this.manager.emit(this.options.event+v,n);this.manager.emit(this.options.event,n)}});l(oa,Q,{defaults:{event:"tap",pointers:1,taps:1,interval:300,time:250,threshold:9,posThreshold:10},getTouchAction:function(){return["manipulation"]},process:function(n){var v=this.options,w=n.pointers.length===v.pointers,B=n.distance<v.threshold,C=n.deltaTime<v.time;this.reset();if(n.eventType&1&&0===this.count)return this.failTimeout();if(B&&C&&w){if(4!=
n.eventType)return this.failTimeout();w=this.pTime?n.timeStamp-this.pTime<v.interval:!0;B=!this.pCenter||N(this.pCenter,n.center)<v.posThreshold;this.pTime=n.timeStamp;this.pCenter=n.center;this.count=B&&w?this.count+1:1;this._input=n;if(0===this.count%v.taps)return this.hasRequireFailures()?(this._timer=f(function(){this.state=8;this.tryEmit()},v.interval,this),2):8}return 32},failTimeout:function(){this._timer=f(function(){this.state=32},this.options.interval,this);return 32},reset:function(){clearTimeout(this._timer)},
emit:function(){8==this.state&&(this._input.tapCount=this.count,this.manager.emit(this.options.event,this._input))}});X.VERSION="2.0.8";X.defaults={domEvents:!1,touchAction:"compute",enable:!0,inputTarget:null,inputClass:null,preset:[[aa,{enable:!1}],[Z,{enable:!1},["rotate"]],[ma,{direction:6}],[fa,{direction:6},["swipe"]],[oa],[oa,{event:"doubletap",taps:2},["tap"]],[W]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}};
ra.prototype={set:function(n){Y(this.options,n);n.touchAction&&this.touchAction.update();n.inputTarget&&(this.input.destroy(),this.input.target=n.inputTarget,this.input.init());return this},stop:function(n){this.session.stopped=n?2:1},recognize:function(n){var v=this.session;if(!v.stopped){this.touchAction.preventDefaults(n);var w=this.recognizers,B=v.curRecognizer;if(!B||B&&B.state&8)B=v.curRecognizer=null;for(var C=0;C<w.length;){var E=w[C];2===v.stopped||B&&E!=B&&!E.canRecognizeWith(B)?E.reset():
E.recognize(n);!B&&E.state&14&&(B=v.curRecognizer=E);C++}}},get:function(n){if(n instanceof Q)return n;for(var v=this.recognizers,w=0;w<v.length;w++)if(v[w].options.event==n)return v[w];return null},add:function(n){if(g(n,"add",this))return this;var v=this.get(n.options.event);v&&this.remove(v);this.recognizers.push(n);n.manager=this;this.touchAction.update();return n},remove:function(n){if(g(n,"remove",this))return this;if(n=this.get(n)){var v=this.recognizers;n=u(v,n);-1!==n&&(v.splice(n,1),this.touchAction.update())}return this},
on:function(n,v){if(n!==e&&v!==e){var w=this.handlers;h(r(n),function(B){w[B]=w[B]||[];w[B].push(v)});return this}},off:function(n,v){if(n!==e){var w=this.handlers;h(r(n),function(B){v?w[B]&&w[B].splice(u(w[B],v),1):delete w[B]});return this}},emit:function(n,v){this.options.domEvents&&Ea(n,v);var w=this.handlers[n]&&this.handlers[n].slice();if(w&&w.length)for(v.type=n,v.preventDefault=function(){v.srcEvent.preventDefault()},n=0;n<w.length;)w[n](v),n++},destroy:function(){this.element&&wa(this,!1);
this.handlers={};this.session={};this.input.destroy();this.element=null}};Y(X,{INPUT_START:1,INPUT_MOVE:2,INPUT_END:4,INPUT_CANCEL:8,STATE_POSSIBLE:1,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:1,DIRECTION_LEFT:2,DIRECTION_RIGHT:4,DIRECTION_UP:8,DIRECTION_DOWN:16,DIRECTION_HORIZONTAL:6,DIRECTION_VERTICAL:24,DIRECTION_ALL:30,Manager:ra,Input:D,TouchAction:da,TouchInput:P,MouseInput:R,PointerEventInput:ia,TouchMouseInput:T,SingleTouchInput:ca,
Recognizer:Q,AttrRecognizer:O,Tap:oa,Pan:fa,Swipe:ma,Pinch:Z,Rotate:aa,Press:W,on:p,off:x,each:h,merge:Ga,extend:xa,assign:Y,inherit:l,bindFn:m,prefixed:A});("undefined"!==typeof b?b:"undefined"!==typeof self?self:{}).Hammer=X;"function"===typeof define&&define.amd?define(function(){return X}):"undefined"!=typeof module&&module.exports?module.exports=X:b[d]=X})(window,document,"Hammer");
...
!0;f.parameters.toScale=1;f.parameters.scale=1;f.options&&f.options.zoomOut&&f.options.zoomOut()};this.animateToScale=function(f,g,h){if(!f.parameters.eventCancel&&!f.parameters.zoomming){f.options&&f.options.zoomStart&&f.options.zoomStart();f.parameters.zoomming=!0;var k=0,l=0,m=0,q=0,p=0;f.animateInterval=function(x,t){k=$.easing.swing(null,m,f.parameters.width,f.parameters.width*(g-1),20);l=$.easing.swing(null,m,f.parameters.height,f.parameters.height*(g-1),20);q=$.easing.swing(null,m,f.parameters.left,
f.parameters.naturalLeft+50*(f.parameters.naturalWidth-f.parameters.width*g)/100-f.parameters.left,20);p=$.easing.swing(null,m,f.parameters.top,f.parameters.naturalTop+50*(f.parameters.naturalHeight-f.parameters.height*g)/100-f.parameters.top,20);f.css({width:k+"px",height:l+"px",left:q+"px",top:p+"px"});for(var r=0;r<f.side.pageArray.length;r++)if(f.side.pageArray[r])f.side.pageArray[r].onResize(k/2,l);m++;if(20<=m||x>=t){f.animateInterval.stop();f.parameters.left=f.parameters.naturalLeft+50*(f.parameters.naturalWidth-
...
(f.y+=d.parameters.height*e/4),BookInfo.isLeftPage(g[0],!0)||bookConfig.FlipDirection||(f.x-=d.parameters.width*e/4),BookInfo.isLeftPage(g[0],!0)&&!bookConfig.FlipDirection&&(f.x+=d.parameters.width*e/4))}return f}d.parameters.origin||(d.parameters.origin={x:0,y:0});g=f.x;f=f.y;var h=d.parameters.width;var k=d.parameters.height;var l=d.parameters.left-d.parameters.origin.x*(e-1)*h/100;var m=d.parameters.top-d.parameters.origin.y*(e-1)*k/100;var q=e*h,p=e*k,x=0,t=0,r=0,u=0;toolBar&&(x=0===toolBar.getTopHeight()?
0:toolBar.getTopHeight()+10,t=0===toolBar.getBottomHeight()?0:toolBar.getBottomHeight()+10,r=0===toolBar.getLeftWidth()?0:toolBar.getLeftWidth()+10,u=0===toolBar.getRightWidth()?0:toolBar.getRightWidth()+10);if(q>windowWidth){var y=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-u;l=-l-h*e*d.parameters.zoomArea.left/100+r}else y=-l-h*e*d.parameters.zoomArea.left/100+r,l=windowWidth-q-l+h*e*d.parameters.zoomArea.right/100-u;p>windowHeight?(h=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-
t,d=-m-k*e*d.parameters.zoomArea.top/100+x):(h=-m-k*e*d.parameters.zoomArea.top/100+x,d=windowHeight-p-m+k*e*d.parameters.zoomArea.bottom/100-t);g=Number.between(g,y,l);f=Number.between(f,h,d);return{x:parseInt(g),y:parseInt(f)}}};this.pinchMoveIn=function(d,e,f){if(!d.parameters.eventCancel&&!d.parameters.zoomming&&f&&f.pointers&&2==f.pointers.length){var g={};g.scale=e;g.tran=d.mathTran(d,f,d.parameters.origin);d.transformSetting(d,g);d.parameters.toScale=e}};this.mathTran=function(d,e,f){if(!e||
...
this.parameters.naturalHeight=$(this).height();this.setZoomSize();var h={};h.scale=d;h.tran=e;h.origin=f;this.zoomTran=h;this.originObj(this,h.origin);try{var k=$.easing.easeOutSine,l=function(){(function(q,p){m(q,p,"Sine")}).animation(this,300)}.bind(this),m=function(q,p,x){if(q<p){x=k(null,q,this.parameters.tran.x,e.x-this.parameters.tran.x,p);var t=k(null,q,this.parameters.tran.y,e.y-this.parameters.tran.y,p);q=k(null,q,this.parameters.scale,d-this.parameters.scale,p);p={};p.scale=q;p.tran={x:x,
y:t};x=transformCSS(p);this.css(x)}else if(this.transformSetting(this,h),this.parameters.scale=d,this.parameters.toScale=d,this.parameters.zoomming=!1,this.options.onZoomed)this.options.onZoomed(h)}.bind(this);l()}catch(q){}}}};this.animateToScale=function(d,e,f,g){if(!d.parameters.eventCancel&&!d.parameters.zoomming){d.options&&d.options.zoomStart&&d.options.zoomStart();d.parameters.zoomming=!0;var h={};h.origin=d.parameters.origin;h.scale=e;h.tran=this.mathTran(d,f,h.origin);h.tran=this.tranLimit(d,
e,h.tran);this.zoomTran=h;this.animation(d,e,h,g)}};this.animation=function(d,e,f,g){var h=transformCSS(f);d.originObj(d,f.origin);animateOnce(d,h,void 0==g?600:g,function(){getTransform(d[0]);d.transformSetting(d,f);d.parameters.scale=e;d.parameters.toScale=e;d.parameters.zoomming=!1;var k=(d.parameters.width*d.parameters.toScale).toFixed(2),l=(d.parameters.height*d.parameters.toScale).toFixed(2),m=d.parameters.naturalWidth,q=d.parameters.naturalHeight;if(Number.isBetween(k,m-1,m+1)||Number.isBetween(l,
...
f=f[0];void 0==c&&(c=!1);var m=getHost(f.src),q=getHost();if(m&&q!==m){if(g=f.src.replace(m,q),f.src=g,0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(u){}})}else{g.width=k;g.height=l;try{h.drawImage(f,0,0,f.naturalWidth,f.naturalHeight,0,0,k,l);var p=h.getImageData(0,0,k,l),x=h.getImageData(0,0,k,l);if(1!=f.colorChanged&&p){var t=Color(b).split();k=0;for(var r=p.data.length;k<r;k+=4)0<x.data[k+3]&&(p.data[k]!=t.r&&(x.data[k]=p.data[k]/255*t.r),p.data[k+1]!=t.g&&(x.data[k+1]=
p.data[k+1]/255*t.g),p.data[k+2]!=t.b&&(x.data[k+2]=p.data[k+2]/255*t.b));h.putImageData(x,0,0);f.src=g.toDataURL("image/png");void 0!=d&&d(e);f.colorChanged=!0}}catch(u){if(0==c)$(f).on("load",function(){try{e.changeButtonColor(b,!0,d)}catch(y){}})}}}}};
...
!0;m=new Date;r=(m-l)/20;var u=h-f,y=k-g;0==r?t=x=0:(x=u/r,t=y/r);void 0!=b&&b(x,t);window.clearInterval(q);q=-1}var f,g,h,k,l,m,q=-1,p=!1,x=0,t=0;try{this.bind("mousedown",c),this.bind("mousemove",d),this.bind("mouseup",e),this.bind("mouseleave",e)}catch(r){}try{this.bind("touchstart",c),this.bind("touchmove",d),this.bind("touchend",e),this.bind("touchleave",e)}catch(r){}};
(function(b){var c="object"==typeof exports&&exports,d="object"==typeof module&&module&&module.exports==c&&module,e="object"==typeof global&&global;if(e.global===e||e.window===e)b=e;var f=function(k){this.message=k};f.prototype=Error();f.prototype.name="InvalidCharacterError";var g={encode:function(k){k=String(k);if(/[^\0-\xFF]/.test(k))throw new f("The string to be encoded contains characters outside of the Latin1 range.");for(var l=k.length%3,m="",q=-1,p,x,t,r=k.length-l;++q<r;)p=k.charCodeAt(q)<<
16,x=k.charCodeAt(++q)<<8,t=k.charCodeAt(++q),p=p+x+t,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>18&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>12&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>6&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p&63);2==l?(p=k.charCodeAt(q)<<8,x=k.charCodeAt(++q),p+=x,m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>
10)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>4&63)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p<<2&63)+"="):1==l&&(p=k.charCodeAt(q),m+="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p>>2)+"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".charAt(p<<4&63)+"==");return m},decode:function(k){k=String(k);for(var l=k.length,m=0,q,p,x="",t=-1;++t<l;)p="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/".indexOf(k.charAt(t)),
...
(function(b){function c(t,r){var u=(t&65535)+(r&65535);return(t>>16)+(r>>16)+(u>>16)<<16|u&65535}function d(t,r,u,y,z,A){t=c(c(r,t),c(y,A));return c(t<<z|t>>>32-z,u)}function e(t,r,u,y,z,A,F){return d(r&u|~r&y,t,r,z,A,F)}function f(t,r,u,y,z,A,F){return d(r&y|u&~y,t,r,z,A,F)}function g(t,r,u,y,z,A,F){return d(u^(r|~y),t,r,z,A,F)}function h(t,r){t[r>>5]|=128<<r%32;t[(r+64>>>9<<4)+14]=r;var u=1732584193,y=-271733879,z=-1732584194,A=271733878;for(r=0;r<t.length;r+=16){var F=u;var D=y;var M=z;var K=A;
u=e(u,y,z,A,t[r],7,-680876936);A=e(A,u,y,z,t[r+1],12,-389564586);z=e(z,A,u,y,t[r+2],17,606105819);y=e(y,z,A,u,t[r+3],22,-1044525330);u=e(u,y,z,A,t[r+4],7,-176418897);A=e(A,u,y,z,t[r+5],12,1200080426);z=e(z,A,u,y,t[r+6],17,-1473231341);y=e(y,z,A,u,t[r+7],22,-45705983);u=e(u,y,z,A,t[r+8],7,1770035416);A=e(A,u,y,z,t[r+9],12,-1958414417);z=e(z,A,u,y,t[r+10],17,-42063);y=e(y,z,A,u,t[r+11],22,-1990404162);u=e(u,y,z,A,t[r+12],7,1804603682);A=e(A,u,y,z,t[r+13],12,-40341101);z=e(z,A,u,y,t[r+14],17,-1502002290);
y=e(y,z,A,u,t[r+15],22,1236535329);u=f(u,y,z,A,t[r+1],5,-165796510);A=f(A,u,y,z,t[r+6],9,-1069501632);z=f(z,A,u,y,t[r+11],14,643717713);y=f(y,z,A,u,t[r],20,-373897302);u=f(u,y,z,A,t[r+5],5,-701558691);A=f(A,u,y,z,t[r+10],9,38016083);z=f(z,A,u,y,t[r+15],14,-660478335);y=f(y,z,A,u,t[r+4],20,-405537848);u=f(u,y,z,A,t[r+9],5,568446438);A=f(A,u,y,z,t[r+14],9,-1019803690);z=f(z,A,u,y,t[r+3],14,-187363961);y=f(y,z,A,u,t[r+8],20,1163531501);u=f(u,y,z,A,t[r+13],5,-1444681467);A=f(A,u,y,z,t[r+2],9,-51403784);
z=f(z,A,u,y,t[r+7],14,1735328473);y=f(y,z,A,u,t[r+12],20,-1926607734);u=d(y^z^A,u,y,t[r+5],4,-378558);A=d(u^y^z,A,u,t[r+8],11,-2022574463);z=d(A^u^y,z,A,t[r+11],16,1839030562);y=d(z^A^u,y,z,t[r+14],23,-35309556);u=d(y^z^A,u,y,t[r+1],4,-1530992060);A=d(u^y^z,A,u,t[r+4],11,1272893353);z=d(A^u^y,z,A,t[r+7],16,-155497632);y=d(z^A^u,y,z,t[r+10],23,-1094730640);u=d(y^z^A,u,y,t[r+13],4,681279174);A=d(u^y^z,A,u,t[r],11,-358537222);z=d(A^u^y,z,A,t[r+3],16,-722521979);y=d(z^A^u,y,z,t[r+6],23,76029189);u=d(y^
z^A,u,y,t[r+9],4,-640364487);A=d(u^y^z,A,u,t[r+12],11,-421815835);z=d(A^u^y,z,A,t[r+15],16,530742520);y=d(z^A^u,y,z,t[r+2],23,-995338651);u=g(u,y,z,A,t[r],6,-198630844);A=g(A,u,y,z,t[r+7],10,1126891415);z=g(z,A,u,y,t[r+14],15,-1416354905);y=g(y,z,A,u,t[r+5],21,-57434055);u=g(u,y,z,A,t[r+12],6,1700485571);A=g(A,u,y,z,t[r+3],10,-1894986606);z=g(z,A,u,y,t[r+10],15,-1051523);y=g(y,z,A,u,t[r+1],21,-2054922799);u=g(u,y,z,A,t[r+8],6,1873313359);A=g(A,u,y,z,t[r+15],10,-30611744);z=g(z,A,u,y,t[r+6],15,-1560198380);
y=g(y,z,A,u,t[r+13],21,1309151649);u=g(u,y,z,A,t[r+4],6,-145523070);A=g(A,u,y,z,t[r+11],10,-1120210379);z=g(z,A,u,y,t[r+2],15,718787259);y=g(y,z,A,u,t[r+9],21,-343485551);u=c(u,F);y=c(y,D);z=c(z,M);A=c(A,K)}return[u,y,z,A]}function k(t){var r,u="",y=32*t.length;for(r=0;r<y;r+=8)u+=String.fromCharCode(t[r>>5]>>>r%32&255);return u}function l(t){var r,u=[];u[(t.length>>2)-1]=void 0;for(r=0;r<u.length;r+=1)u[r]=0;var y=8*t.length;for(r=0;r<y;r+=8)u[r>>5]|=(t.charCodeAt(r/8)&255)<<r%32;return u}function m(t){return k(h(l(t),
8*t.length))}function q(t,r){var u=l(t),y=[],z=[];y[15]=z[15]=void 0;16<u.length&&(u=h(u,8*t.length));for(t=0;16>t;t+=1)y[t]=u[t]^909522486,z[t]=u[t]^1549556828;r=h(y.concat(l(r)),512+8*r.length);return k(h(z.concat(r),640))}function p(t){var r="",u;for(u=0;u<t.length;u+=1){var y=t.charCodeAt(u);r+="0123456789abcdef".charAt(y>>>4&15)+"0123456789abcdef".charAt(y&15)}return r}function x(t,r,u){r?u?t=q(unescape(encodeURIComponent(r)),unescape(encodeURIComponent(t))):(t=q(unescape(encodeURIComponent(r)),
unescape(encodeURIComponent(t))),t=p(t)):t=u?m(unescape(encodeURIComponent(t))):p(m(unescape(encodeURIComponent(t))));return t}"function"===typeof define&&define.amd?define(function(){return x}):"object"===typeof module&&module.exports?module.exports=x:b.md5=x})(this);String.prototype.MD5=function(b){return md5(this)};
...
function debounceAsyncByKey(b,c,d){var e={},f={};d=d||function(g){return g[0]};return function(g){for(var h=[],k=0;k<arguments.length;++k)h[k-0]=arguments[k];var l=this,m=d(h);e[m]&&clearTimeout(e[m]);return new Promise(function(q,p){f[m]||(f[m]=[]);f[m].push({resolve:q,reject:p});e[m]=setTimeout(function(){var x,t;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){switch(r.nextAddress){case 1:return r.setCatchFinallyBlocks(2,3),r.yield(b.apply(l,h),5);case 5:x=r.yieldResult,f[m].forEach(function(u){return u.resolve(x)});
case 3:r.enterFinallyBlock();delete e[m];delete f[m];r.leaveFinallyBlock(0);break;case 2:t=r.enterCatchBlock(),f[m].forEach(function(u){return u.reject(t)}),r.jumpTo(3)}})},c)})}}
...
k.src=b;k.onload=function(){var l=document.createElement("canvas"),m=l.getContext("2d");l.width=k.width;l.height=k.height;m.drawImage(k,0,0);for(var q=m.getImageData(0,0,l.width,l.height),p=q.data,x=c?e(c):null,t=d?e(d):{r:0,g:0,b:0,a:0},r=0;r<p.length;r+=4){var u=p[r+3];0===u?(p[r]=t.r,p[r+1]=t.g,p[r+2]=t.b,p[r+3]=void 0!==t.a?t.a:0):0<u&&255>u?x&&(p[r]=Math.round((x.r*u+t.r*(255-u))/255),p[r+1]=Math.round((x.g*u+t.g*(255-u))/255),p[r+2]=Math.round((x.b*u+t.b*(255-u))/255),p[r+3]=255):x&&(p[r]=x.r,
p[r+1]=x.g,p[r+2]=x.b,p[r+3]=void 0!==x.a?x.a:255)}m.putImageData(q,0,0);g(l.toDataURL())};k.onerror=function(l){return h(l)}})}var getRandomColor=function(){return"#"+Math.floor(1118481+14540253*Math.random()).toString(16)};function normalizeUrl(b){return b&&"string"===typeof b?b.replace(/\\\//g,"/"):b}
(function(b){function c(p,x){try{var t=x&&"object"===typeof x?Object.assign({},x):x;if(t&&"object"===typeof t){t.page=Number(p+1);var r=h[p];r&&r.positions&&t.positions?t.positions=r.positions.concat(t.positions):r&&r.positions&&(t.positions=r.positions);null!=l?t.realPage=Number(l):r&&r.realPage&&(t.realPage=r.realPage);r&&Object.keys(r).forEach(function(u){"page"===u||"realPage"===u||"positions"===u||u in t||(t[u]=r[u])})}h[p]=t;return!0}catch(u){return console.error("writeToTarget error",u),!1}}
function d(p,x,t){if(!p||0===p.length)return null;for(var r=p[0].left,u=p[0].top,y=p[0].right,z=p[0].bottom,A="",F=0;F<p.length;F++){var D=p[F];r=Math.min(r,D.left);u=Math.min(u,D.top);y=Math.max(y,D.right);z=Math.max(z,D.bottom);A+=D.text||""}F=r/x;u/=t;y/=x;t=z/t;t=[F,t,y,t,y,u,F,u];z=[];for(F=0;F<p.length;F++)z.push(p[F].width/x);if(!A||0===A.trim().length)return null;p=t.concat(z);return{w:A,p:p}}function e(p){b._pageReaderExtracted||(b._pageReaderExtracted={});p=Array.isArray(p)?p:[p];for(var x=
0,t=0;t<p.length;t++){var r=p[t];if(r&&!(1>r)&&!b._pageReaderExtracted[r])if(window._getPage&&"function"===typeof window._getPage)try{var u=window._getPage(r-1);if(u){var y=null;if(u.items&&Array.isArray(u.items)){y=u.items;for(var z=window.readerConfig.pageConfig.pageWidth,A=window.readerConfig.pageConfig.pageHeight,F=0,D=0;D<y.length;D++){var M=y[D];if(M&&"text"===M.type&&M.positionText&&M.style){var K=M,H=r,I=z,N=A;b.positionForPages||(b.positionForPages=[]);var J=K;if(J&&J.positionText&&J.style){K=
[];var R=parseFloat(J.style.left)||0,ia=parseFloat(J.style.top)||0,ca=J.positionText;for(J=0;J<ca.length;J++){var P=ca[J];if(P&&P.rowText&&0!==P.rowText.length){for(var S=P.rowText,T=[],ja=null,da=0;da<S.length;da++){var V=S[da];if(V&&V.text){var Q=R+(V.left||0),la=ia+(V.top||0),ka=V.width||0,ea=V.height||0,O=Q+ka,fa=!1;null!==ja&&Q-ja>.5*ka&&(fa=!0);if(fa&&0<T.length){var Z=d(T,I,N);Z&&K.push(Z);T=[]}T.push({text:V.text,left:Q,top:la,width:ka,height:ea,right:O,bottom:la+ea});ja=O}}0<T.length&&(Z=
d(T,I,N))&&K.push(Z)}}var W=K}else W=[];if(0!==W.length){I=H-1;var aa=positionForPages[I];aa?(aa.positions&&Array.isArray(aa.positions)?positionForPages[I].positions=aa.positions.concat(W):positionForPages[I].positions=W,positionForPages[I].page=H):positionForPages[I]={page:H,positions:W}}F++}}b._pageReaderExtracted[r]=!0;x+=F;0<F?console.log("PageTextExtractor: \u6210\u529f\u63d0\u53d6\u5e76\u6dfb\u52a0 "+F+" \u4e2a\u6587\u672c\u914d\u7f6e\u5230 positionForPages (\u9875\u9762 "+(r-1)+")"):console.log("PageTextExtractor: \u9875\u9762 "+
(r-1)+" \u4e2d\u6ca1\u6709\u627e\u5230\u6587\u672c\u5143\u7d20")}else console.warn("PageTextExtractor: \u9875\u9762\u6570\u636e\u683c\u5f0f\u4e0d\u6b63\u786e\uff0c\u671f\u671b {items: [...]}")}else console.warn("PageTextExtractor: \u65e0\u6cd5\u83b7\u53d6\u9875\u9762 "+(r-1)+" \u7684\u6570\u636e")}catch(ma){console.error("PageTextExtractor: \u63d0\u53d6\u9875\u9762 "+(r-1)+" \u7684\u6587\u672c\u914d\u7f6e\u65f6\u51fa\u9519",ma)}else console.warn("PageTextExtractor: window._getPage \u65b9\u6cd5\u4e0d\u5b58\u5728\uff0c\u65e0\u6cd5\u63d0\u53d6\u6587\u672c\u914d\u7f6e")}return x}
function f(p){var x,t,r,u,y;return $jscomp.asyncExecutePromiseGeneratorProgram(function(z){switch(z.nextAddress){case 1:if(!p||1>p)return z.return(!1);b._positionScriptLoaded||(b._positionScriptLoaded={});x=b.getSearchRealPageIndex(p);if(0>=x||-1===x||b._positionScriptLoaded[x])return z.return(!1);t=String.format(bookConfig.searchPositionJS,x);1<x&&(t=t.replace("[1]","["+x+"]"));r=/\.*\/?(\w+\/)*\w+(\[|\()?\d+(\]|\))?\.js/gi;u=/\.*\/?(\w+\/)*\w+?\.js/gi;return t.match(r)||t.match(u)?z.yield(getArticleImage(fixURLValue(t)),
2):z.return(!1);case 2:t=z.yieldResult;if(!t)return z.return(!1);z.setCatchFinallyBlocks(3);return z.yield(g(p,t,x),5);case 5:return b._positionScriptLoaded[x]=!0,z.return(!0);case 3:return y=z.enterCatchBlock(),console.error("loadPagePositionScript: \u52a0\u8f7d\u5931\u8d25",y),z.return(!1)}})}function g(p,x,t){var r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){r=function(){var y,z,A,F,D,M,K;return $jscomp.asyncExecutePromiseGeneratorProgram(function(H){switch(H.nextAddress){case 1:k=
p;l=t;if(y="undefined"!==typeof location&&"file:"===location.protocol){H.jumpTo(2);break}H.setCatchFinallyBlocks(3);return H.yield(fetch(x),5);case 5:z=H.yieldResult;if(!z.ok){console.warn("fetch returned non-ok",z.status,x);H.jumpTo(6);break}return H.yield(z.text(),7);case 7:return A=H.yieldResult,F=A.match(/positionForPages\[(\d+)\]/),D=A,F&&(D=D.replace(new RegExp("positionForPages\\["+F[1]+"\\]","g"),"positionForPages["+(p-1)+"]")),D=D.replace(/("page"\s*:\s*)"?\d+"?/g,"$1"+p),(new Function(D))(),
l=k=null,H.return();case 6:H.leaveTryBlock(2);break;case 3:M=H.enterCatchBlock(),console.warn("fetch failed, fallback to script tag (likely file://). Error:",M&&M.message);case 2:return K="undefined"!==typeof window?window:"undefined"!==typeof b?b:null,K?H.yield(new Promise(function(I,N){var J=K.document.createElement("script");J.dataset.positionSource=x;J.onload=function(){setTimeout(function(){l=k=null;I()},0)};J.onerror=function(R){l=k=null;console.log("Script load failed:",x,R);N(Error("Script load failed: "+
x))};J.src=x;K.document.head.appendChild(J)}),0):(console.log("\u65e0\u6cd5\u627e\u5230 window \u6216 global \u5bf9\u8c61"),H.return())}})};m=m.then(function(){return r()}).catch(function(y){console.log("queue error:",y&&y.message)});return u.return(m)})}var h=[],k=null,l=null,m=Promise.resolve(),q=new Proxy({},{get:function(p,x){return"string"===typeof x&&/^\d+$/.test(x)?h[Number(x)]:"length"===x?h.length:"function"===typeof Array.prototype[x]?Array.prototype[x].bind(h):p[x]},set:function(p,x,t){return"string"===
typeof x&&/^\d+$/.test(x)?(p=Number(x),null!=k?c(k-1,t):c(p,t),!0):!1},has:function(p,x){return"string"===typeof x&&/^\d+$/.test(x)?x in h:x in p},ownKeys:function(){return Object.keys(h).concat(Object.getOwnPropertyNames(Object.prototype))},getOwnPropertyDescriptor:function(p,x){return"string"===typeof x&&/^\d+$/.test(x)?{configurable:!0,enumerable:!0,value:h[Number(x)],writable:!0}:Object.getOwnPropertyDescriptor(p,x)}});"undefined"!==typeof window?Object.defineProperty(window,"positionForPages",
{configurable:!1,enumerable:!0,writable:!1,value:q}):"undefined"!==typeof b&&Object.defineProperty(b,"positionForPages",{configurable:!1,enumerable:!0,writable:!1,value:q});b.extractPageTextConfigs=e;b.loadPageTextInfo=function(p){var x,t,r,u,y,z,A,F;return $jscomp.asyncExecutePromiseGeneratorProgram(function(D){switch(D.nextAddress){case 1:b._positionScriptLoaded||(b._positionScriptLoaded={}),b._pageReaderExtracted||(b._pageReaderExtracted={}),b.positionForPages||(b.positionForPages=[]),x=Array.isArray(p)?
p:[p],t=[],r=!1,u=0;case 2:if(!(u<x.length)){D.jumpTo(4);break}y=x[u];if(!y||1>y){D.jumpTo(3);break}z={pageIndex:y,hasText:!1,positionCount:0};D.setCatchFinallyBlocks(5);return D.yield(f(y),7);case 7:b._pageReaderExtracted[y]||e(y);(A=positionForPages[y-1])&&A.page===y&&A.positions&&Array.isArray(A.positions)&&0<A.positions.length&&(z.hasText=!0,z.positionCount=A.positions.length,r=!0);D.leaveTryBlock(6);break;case 5:F=D.enterCatchBlock(),console.log("loadPageTextInfo: \u52a0\u8f7d\u9875\u9762 "+
y+" \u7684\u6587\u672c\u4fe1\u606f\u65f6\u51fa\u9519",F);case 6:t.push(z);case 3:u++;D.jumpTo(2);break;case 4:return D.return({hasText:r,pageResults:t})}})};b.hasPageText=function(p){b.positionForPages||(b.positionForPages=[]);var x=!Array.isArray(p),t=[],r=!1;p=$jscomp.makeIterator(x?[p]:p);for(var u=p.next();!u.done;u=p.next())if(u=u.value,!u||1>u)x||t.push({pageIndex:u,hasText:!1,positionCount:0});else{var y={pageIndex:u,hasText:!1,positionCount:0},z=positionForPages[u-1];z&&z.page===u&&z.positions&&
Array.isArray(z.positions)&&0<z.positions.length&&(y.hasText=!0,y.positionCount=z.positions.length,r=!0);if(x)return y.hasText;t.push(y)}return{hasText:r,pageResults:t}};b.loadPagePositionScript=f;b.loadAndFixPositionScript=g})("undefined"!==typeof window?window:"undefined"!==typeof global?global:this);
...
("undefined"!==typeof c?c:"")).trim(),"string"==typeof r&&(r=r.replaceAll("\\/","/",!0),r=r.replaceAll('\\"','"')),/^(\.\.\/){2}booklogo\.png([?#].*)?$/.test(r)))return""},m,q,p,x,t;if((null==(m=window.tmpBookConfig)?0:null==(q=m.power_info)?0:q.power)||(null==(p=window.bookConfig)?0:null==(x=p.power_info)?0:x.power)||(null==(t=window.userInfo)?0:t.power)||!window.eventEmitter||"function"!==typeof window.eventEmitter.on)return l(k());window.eventEmitter.on("loadUserInfo",function(r){return l(k())})}
...
3);tmpBookConfig.isChatBotButtonVisible=getConfigValue("isChatBotButtonVisible",!1);tmpBookConfig.articleTitlePosition=getConfigValue("articleTitlePosition","Chinese"==UserGroups?"center":"left").toLowerCase();tmpBookConfig.phoneFlipShortcutButtonSize=getConfigValue("phoneFlipShortcutButtonSize","large").toLocaleLowerCase();tmpBookConfig.socialSharingList=getConfigValue("socialSharingList",void 0);tmpBookConfig.socialShareType=getConfigValue("socialShareType","0");tmpBookConfig.isRestorePageFrameVisible=
getConfigValue("isRestorePageFrameVisible",!0);tmpBookConfig.alwaysShowBookInstructionOnStart=getConfigValue("alwaysShowBookInstructionOnStart","0");tmpBookConfig.showBookInstructionCountOnStart=getConfigValue("showBookInstructionCountOnStart",3);tmpBookConfig.toolBarBrandInfoVisible=getConfigValue("toolBarBrandInfoVisible",void 0);void 0!==tmpBookConfig.toolBarBrandInfoVisible&&(tmpBookConfig.toolBarBrandInfoVisible=parseBool(tmpBookConfig.toolBarBrandInfoVisible));tmpBookConfig.toolBarBrandInfoUrl=
getConfigValue("toolBarBrandInfoUrl","");tmpBookConfig.loadingBrandInfoVisible=getConfigValue("loadingBrandInfoVisible",!1);tmpBookConfig.loadingBrandInfoUrl=getConfigValue("loadingBrandInfoUrl","");tmpBookConfig.relatedBrandInfoVisible=getConfigValue("relatedBrandInfoVisible",!1);tmpBookConfig.relatedBrandInfoUrl=getConfigValue("relatedBrandInfoUrl","");tmpBookConfig.relatedCardVisible=getConfigValue("relatedCardVisible",!1);tmpBookConfig.relatedCardUrl=getConfigValue("relatedCardUrl","");tmpBookConfig.bookBaseURL=
getConfigValue("bookBaseURL","");tmpBookConfig.bookResourceBaseURL=getConfigValue("bookResourceBaseURL","");!tmpBookConfig.bookResourceBaseURL&&window.htmlConfig&&window.htmlConfig.loadingConfig&&window.htmlConfig.loadingConfig.bookResourceBaseURL&&(tmpBookConfig.bookResourceBaseURL=window.htmlConfig.loadingConfig.bookResourceBaseURL);!tmpBookConfig.bookResourceBaseURL&&window.bookResourceBaseURL&&(tmpBookConfig.bookResourceBaseURL=window.bookResourceBaseURL);try{tmpBookConfig.bookResourceBaseURL||
...
getConfigValue("backGroundImgURL","");tmpBookConfig.backgroundOpacity=getConfigValue("backgroundOpacity",100);tmpBookConfig.LeftShadowWidth=getConfigValue("LeftShadowWidth",100);tmpBookConfig.LeftShadowAlpha=getConfigValue("LeftShadowAlpha",1);tmpBookConfig.RightShadowWidth=getConfigValue("RightShadowWidth",40);tmpBookConfig.RightShadowAlpha=getConfigValue("RightShadowAlpha",1);_agent_.system.name==_agent_.system.ANDROID&&_agent_.browser.wechat&&(tmpBookConfig.RightShadowAlpha=1,tmpBookConfig.LeftShadowAlpha=
...
getConfigValue("excludeFrontPages","");tmpBookConfig.isFlipPdf=getConfigValue("isFlipPdf",!1);tmpBookConfig.SingleModeBanFlipToLastPage=getConfigValue("SingleModeBanFlipToLastPage",!1);tmpBookConfig.isSingleBookFullWindowOnMobile=getConfigValue("isSingleBookFullWindowOnMobile",!1);tmpBookConfig.showGotoButtonsAtFirst=getConfigValue("showGotoButtonsAtFirst",!1);0==tmpBookConfig.isFlipPdf&&void 0!=global.isFlipPdf&&(tmpBookConfig.isFlipPdf=isFlipPdf);tmpBookConfig.FlipSound=getConfigValue("FlipSound",
!0);global.flipSoundIsPlaying=tmpBookConfig.FlipSound;tmpBookConfig.CurlingPageCorner=getConfigValue("CurlingPageCorner",!0);tmpBookConfig.BanFlipFromDirection=getConfigValue("BanFlipFromDirection",!1);tmpBookConfig.iconFontColor=getConfigValue("iconFontColor","#ffffff");tmpBookConfig.updateURLForPage=getConfigValue("updateURLForPage",!0);tmpBookConfig.borderColor=getConfigValue("borderColor","#572f0d");tmpBookConfig.outerCoverBorder=getConfigValue("outerCoverBorder",!1);tmpBookConfig.hardCoverBorderWidth=
getConfigValue("hardCoverBorderWidth",0);tmpBookConfig.cornerRound=getConfigValue("cornerRound",0);tmpBookConfig.hardCoverBorderWidth=tmpBookConfig.HardPageEnable?Number.between(0,16,tmpBookConfig.hardCoverBorderWidth):0;tmpBookConfig.cornerRound=tmpBookConfig.HardPageEnable?Number.between(0,tmpBookConfig.hardCoverBorderWidth,tmpBookConfig.cornerRound):0;tmpBookConfig.coverTexture=getConfigValue("coverTexture","none");tmpBookConfig.passwardPrompt=getConfigValue("passwardPrompt","");tmpBookConfig.SlideshowAutoPlay=
...
getConfigValue("restorePageVisible",!1);tmpBookConfig.restorePageDuration=getConfigValue("restorePageDuration",86400);tmpBookConfig.toobarClear=getConfigValue("toobarClear",!1);tmpBookConfig.bottomToolBarAlpha=getConfigValue("bottomToolBarAlpha",1);tmpBookConfig.topToolBarAlpha=getConfigValue("topToolBarAlpha",1);tmpBookConfig.ToolBarAlpha=getConfigValue("ToolBarAlpha",1);tmpBookConfig.phoneSearchBarAlpha=getConfigValue("phoneSearchBarAlpha",.8);!isPhone()&&!isPad()||["slide","docview","card","inverteffect"].includes(tmpBookConfig.FlipStyle.toLowerCase())||
...
e=Math.max(e,q)}tmpBookConfig.topMargin=e;var p=tmpBookConfig.ORIGIN_BOTTOM_MARGIN;c&&1==global.staticAd.adPosition&&p<d+20&&(p+=d+20);tmpBookConfig.bottomMargin=p;b.disableResize||"function"!=typeof global.onStageResize||onStageResize()}catch(x){console.log("setBookVerticalMargin error",x)}}
...
function checkFliphtml5PagesConfig(){var b,c,d,e,f,g,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){switch(k.nextAddress){case 1:b=window.htmlConfig.fliphtml5_pages;if("string"!==typeof b){window.fliphtml5_pages=b;k.jumpTo(2);break}k.setCatchFinallyBlocks(3);return k.yield(new Promise(function(l,m){setTimeout(function(){try{var q=allocateUTF8(b),p=Module._DeString(q),x=UTF8ToString(p);Module._FreeMemory(p);if(x&&"undefined"!==x){p=x;var t=p.lastIndexOf("]");0<t&&(p=p.substring(0,
t+1));try{window.fliphtml5_pages=JSON.parse(p)}catch(r){console.log("JSON parse error:",r);try{window.fliphtml5_pages=eval(p)}catch(u){console.log("Failed to parse decrypted fliphtml5_pages:",u),window.fliphtml5_pages=[]}}}else console.log("pages_value is empty or undefined"),window.fliphtml5_pages=[];Module._free(q);l()}catch(r){console.error("Failed to decrypt fliphtml5_pages:",r),window.fliphtml5_pages=[],m(r)}},0)}),5);case 5:k.leaveTryBlock(2);break;case 3:c=k.enterCatchBlock(),console.error("Failed to decrypt fliphtml5_pages:",
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026031701",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
function getArticleEditor(){function b(u){if(window.isExecuteGetInverseEditor)var y=window.setInterval(function(){if(window.runArticleEditor||window.inverseEditor)window.clearInterval(y),u()},10);else window.isExecuteGetInverseEditor=!0,f(),window.articleListConfig?(e(window.articleListConfig),u(),window.runArticleEditor&&delete window.runArticleEditor):bookConfig.articleListPath&&c(bookConfig.articleListPath,function(z){d(z,u)},u,"")}function c(u,y,z,A,F){var D=new XMLHttpRequest;D.responseType=
void 0===A?"json":A;D.open("GET",u);D.send();D.onreadystatechange=function(){4===D.readyState&&(200===D.status||304===D.status?y&&y(D):"bookinfo"===F&&y?y():z&&z(y))};D.error=function(){z&&z(y)}}function d(u,y){r&&(clearTimeout(r),r=null);if(window.Module.isReady){var z=allocateUTF8(u.responseText),A=Module._DeString(z),F=UTF8ToString(A);F=eval(F);Module._free(z);Module._FreeMemory(A);e(F);y();window.runArticleEditor&&delete window.runArticleEditor}else r=setTimeout(function(){d(u,y)},100)}function e(u){(window.articleListConfig=
u)?g(u):window.inverseEditor=[]}function f(){(bookConfig.articleConfigPath||bookConfig.bookArticleConfigPath||bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId||bookConfig.userArticleConfigPath)&&q(function(u){window.articleConfig=u.response})}function g(u){for(var y=[],z=window.bookConfig.totalPageCount,A=window.htmlConfig?window.htmlConfig.search_pages:[],F=0;F<z;F++){for(var D=A&&A.length&&A[F]?A[F].index:F,M=[],K=0;K<u.length;K++)(u[K].articles?u[K].articles:[]).forEach(function(H){if(H.isShowLinkSplited){if(H.articleTextList&&
H.articleTextList.length){var I=l(H.articleTextList,D);console.log(I,D);H=k(H);for(var N=0;N<I.length;N++){var J=h(H,I[N]);M.push(J)}}}else{I="";if(""===H.activePage||void 0===H.activePage||H.activePage&&(-2===parseFloat(H.activePage)||parseFloat(H.activePage)===D))a:{I=D;N={};H.collapseArea&&(N=JSON.parse(H.collapseArea));if(N[I])I={rect:N[I]};else{if(!H.articleTextList||!H.articleTextList.length){I="";break a}I=m(H.articleTextList,I)}I="[object Object]"===Object.prototype.toString.call(I)?{tannoName:"link1",
x:I.rect.x,y:I.rect.y,width:I.rect.width,height:I.rect.height,rotation:"0",reflection:"false",reflectionType:"0",reflectionAlpha:"0",pageWidth:I.rect.pageWidth,pageHeight:I.rect.pageHeight}:""}I&&H.articleTextList&&H.articleTextList.length&&(H=k(H),J=h(H,I),M.push(J))}});y.push(M)}console.log("currentPageEditor",JSON.parse(JSON.stringify(y)));window.inverseEditor=y}function h(u,y){window.articleConfig||(window.articleConfig={});window.articleConfig.hotArea||(window.articleConfig.hotArea={overColor:"#4997ee",
...
(y.text=y.text.replace(/\n[ ]+/g,"<br>&emsp;&emsp;"));return y});return{articleId:u.articleId,newTime:u.newTime,title:u.title,subTitle:u.subTitle,author:u.author,categoryId:u.categoryId,articleTextList:u.articleTextList}}function l(u,y){var z=[];u.forEach(function(A){-1!==y&&(A.pageIndex===y||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(F){return F.pageIndex===y}).length)&&(A.mergeList&&A.mergeList.length?(A=l(A.mergeList,y),A.length&&(z=[].concat($jscomp.arrayFromIterable(z),$jscomp.arrayFromIterable(A)))):
z.push(A.rect))});return z}function m(u,y){var z="";u.forEach(function(A){if(-1!==y&&(A.pageIndex===y||A.mergeList&&A.mergeList.length&&A.mergeList.filter(function(D){return D.pageIndex===y}).length))if(""===z)z=A.mergeList&&A.mergeList.length?m(A.mergeList,y):JSON.parse(JSON.stringify(A));else{if(A.mergeList&&A.mergeList.length){var F=[z].concat(A.mergeList);z=m(F,y)}z.rect.x>A.rect.x&&(z.rect.x=A.rect.x);z.rect.y>A.rect.y&&(z.rect.y=A.rect.y);z.rect.endX<A.rect.endX&&(z.rect.endX=A.rect.endX);z.rect.endY<
A.rect.endY&&(z.rect.endY=A.rect.endY);z.rect.width=z.rect.endX-z.rect.x;z.rect.height=z.rect.endY-z.rect.y}});return z}function q(u){bookConfig.articleConfigPath?c(bookConfig.articleConfigPath,u,p):p(u)}function p(u){bookConfig.bookArticleConfigPath?c(bookConfig.bookArticleConfigPath,u,x):x(u)}function x(u){if(bookConfig.periodsConfigPath&&window.book_visit&&window.book_visit.periodicalId){var y=bookConfig.periodsConfigPath;y=y.replace("%periodicalId%",window.book_visit.periodicalId);c(y,u,t)}else t(u)}
function t(u){bookConfig.userArticleConfigPath?c(bookConfig.userArticleConfigPath,u):u&&u()}var r;return $jscomp.asyncExecutePromiseGeneratorProgram(function(u){return u.return(new Promise(function(y,z){window.templeteName&&!window.templeteName.toLowerCase().match(/article/)?y():window.runArticleEditor||window.inverseEditor?y():(console.log("create getArticleEditor one time"),bookConfig.articleListPath?(z=bookConfig.bookBaseURL)?(z.endsWith("/")||(z+="/"),c(z+"bookinfo.js",function(A){A&&A.response&&
...
x=0;x<canvasData[b].resources.length;x++)if(1!=canvasData[b].resources[x].type)p++,p>=canvasData[b].resources.length&&k();else{var t=new Image;t.src=getResource(b,x);globalImages[b][x]=t;t.onload=function(){p++;p>=canvasData[b].resources.length&&k()}}})()}.bind(l),error:function(){}});m.jumpToEnd()})})()},objectLoad=function(b,c,d,e,f,g){var h,k,l,m,q,p;return $jscomp.asyncExecutePromiseGeneratorProgram(function(x){h=0;k=$("<div style='position:relative;'></div>");k.css({width:bookConfig.largePageWidth+
"px",height:bookConfig.largePageHeight+"px"});l=function(t){bookConfig.largePageWidth/bookConfig.largePageHeight>t[0].naturalWidth/t[0].naturalHeight?t.css({width:"auto",height:"100%"}):t.css({width:"100%",height:"auto"})};for(m=0;m<c.length;m++)q=c[m],q=q.removeStartFrom("?"),p=$("<img style='position:absolute;left:0;top:0;bottom:0;right:0;margin:auto;'></img>"),p.attr("src",q),k.append(p),p[0].onload=function(t){l($(this));h++;h==c.length&&e&&e(c,c,k,b)},p[0].onerror=function(t){h++;h==c.length&&
...
!0};if(!h(c,b))return!window.userList&&1<passwardType()&&loadJavascript(fixURLValue(bookConfig.userListPath),function(){pageResourceLoad(b,d,e)},function(){}),q.return();if(k=global[decodeDatabasePrefix(d)+b]&&"string"==typeof global[decodeDatabasePrefix(d)+b])return l=dataBase64Str(b,d),m=$("<img src='"+l+"'/>"),m[0].onload=function(){e&&e(l,c,this,b)},q.return();loadJavascript(c,function(p){var x=dataBase64Str(b,d,p);$("<img src='"+x+"'/>")[0].onload=function(){e&&e(x,c,this,b)}},function(){});
return q.return()})},zipLoad=function(b,c,d,e,f,g){var h=this,k,l,m;return $jscomp.asyncExecutePromiseGeneratorProgram(function(q){if(!window.printLoadStack)return q.return();k=f?f:BookInfo.getBook().pageWidth;l=g?g:BookInfo.getBook().pageHeight;m=new PdfLoadingTask(b,d,k,l,function(p){var x=p.toDataURL("image/png"),t=$("<img src='"+x+"'/>");t[0].onload=function(){e&&e(x,x,t,b)}}.bind(h));window.printLoadStack.push(m);return q.return()})},svgLoad=function(b,c,d,e,f,g){var h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){bookConfig.useTheAliCloudChart&&
...
function canvasReload(b,c,d,e){var f=b.width,g=b.height;c=Math.round(c);d=Math.round(d);var h=f/c,k=g/d,l=Math.ceil(h/2),m=Math.ceil(k/2),q=b.getContext("2d"),p=q.getImageData(0,0,f,g),x=q.createImageData(c,d);p=p.data;for(var t=x.data,r=0;r<d;r++)for(var u=0;u<c;u++){for(var y=4*(u+r*c),z,A=0,F=0,D=0,M=0,K=0,H=0,I=(r+.5)*k,N=Math.ceil((r+1)*k),J=Math.floor(r*k);J<N;J++){var R=Math.abs(I-(J+.5))/m,ia=(u+.5)*h;R*=R;for(var ca=Math.ceil((u+1)*h),P=Math.floor(u*h);P<ca;P++)if(z=Math.abs(ia-(P+.5))/l,
z=Math.sqrt(R+z*z),!(1<=z)){z=2*z*z*z-3*z*z+1;var S=4*(P+J*f);H+=z*p[S+3];F+=z;255>p[S+3]&&(z=z*p[S+3]/250);D+=z*p[S];M+=z*p[S+1];K+=z*p[S+2];A+=z}}t[y]=D/A;t[y+1]=M/A;t[y+2]=K/A;t[y+3]=H/F}!0===e?(b.width=c,b.height=d):q.clearRect(0,0,f,g);q.putImageData(x,0,0)}
...
2-c.width/2,b.canvas.height/2-c.height/2,c.rotation,c)):(e=function(k,l,m,q,p){p=void 0===p?!1:p;var x=h[m],t=Math.abs(l-k);if(!(0>=t)){q=q?x.width:x.height;l=0;if(t>=q)for(l=Math.floor((t+c.spacing)/(q+c.spacing));0<l&&!(l*q+(l-1)*c.spacing<=t);)l--;if(!(0>=l)){t=1<l?(t-l*q)/(l-1):0;for(var r=0;r<l;r++){var u=p?k-r*(q+t):k+r*(q+t),y=void 0,z=void 0;switch(m){case "top":y=u+(x.width-c.width)/2;z=(x.height-c.height)/2+f;break;case "right":y=b.canvas.width-(c.width+x.width)/2-f;z=u+(x.height-c.height)/
2;break;case "bottom":y=u+(x.width-c.width)/2;z=b.canvas.height-(c.height+x.height)/2-f;break;case "left":y=(x.width-c.width)/2+f,z=u+(x.height-c.height)/2}WatermarkStrategy.prototype.drawSingleWatermark.call(d,b,y,z,g[m],c,p)}}}},e(f,b.canvas.width-h.right.width-f,"top",!0,!1),e(f,b.canvas.height-h.bottom.height-f,"right",!1,!1),e(h.left.width,b.canvas.width-f,"bottom",!0,!1),e(h.top.height,b.canvas.height-f,"left",!1,!1))};var WatermarkStrategyFactory=function(){};
...
g;this.initEvent()},initEvent:function(){var b=new Hammer.Manager(this.$container[0]);b.add(new Hammer.Pan({threshold:0}));b.add(new Hammer.Tap);b.on("panstart panmove panend",this.selectText.bind(this));b.on("tap",this.onTap.bind(this))},onTap:function(){this.$container&&this.$container.empty();this.hint&&this.hint.hide();global.modernTextCopyButton&&global.modernTextCopyButton.hide()},destroySelect:function(){this.$container&&this.$container.remove();this.hint&&this.hint.destroy();this.$container=
this.hint=void 0;global.modernTextCopyButton&&global.modernTextCopyButton.hide()},selectText:function(b){if(!BookInfo.getBook().flipping&&global.positionForPages){var c=this.pageIndex-1;if(global.positionForPages[c]&&global.positionForPages[c].page==this.pageIndex)var d=global.positionForPages[c].positions;this.$container.empty();if(d){this.searchTextHighlight||(this.searchTextHighlight=new SearchTextHighlight(this.width,this.height,rightToLeft),this.searchTextHighlight.loadFromPage(d),this.highlightDOM=
new SearchHighlightDOM(this.$container));d="Modern"===_get(htmlConfig,"phoneTemplate.name");c=null;if(d){var e=bookConfig.themeColor;e&&(c=Color(e).rgba(.4))}e=this.getArea(b);e=this.searchTextHighlight.selectText(e);this.highlightText="";var f=null;if(e){for(var g=e.getRects(),h=0;h<g.length;){for(var k=[],l=0;4>l;l++)k[l]=g[h+l];0===h&&(f={x:k[0].x,y:k[0].y,width:k[1].x-k[0].x,height:k[3].y-k[0].y});this.highlightDOM.addHighlight(k,c);h+=4}this.highlightText=e.getText()}d&&!this.highlightText&&
...
show:virtual_function,hide:virtual_function,onResize:virtual_function,destroy:virtual_function}),NoteAdd=Class({create:function(b){var c=this;this.noteAdd=$("<div class='anno-noteAdd'></div>");this.noteAdd.on("mousedown mouseup pointerdown",function(d){return d.stopPropagation()});this.noteAdd.on(_event._down,function(){return c.noteAdd.css({opacity:"0.7"})});this.noteAdd.on(_event._up,function(d){var e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){switch(g.nextAddress){case 1:d.stopPropagation();
c.noteAdd.css({opacity:""});if(!bookConfig.AnnotationButtonVisible){g.jumpTo(0);break}if(global.annotationPannel){g.jumpTo(3);break}g.setCatchFinallyBlocks(4);e=bookConfig.UIBaseURL+"javascript/component.min.js";return g.yield(loadComponents(e),6);case 6:global.initForms&&global.initForms();global.resizeComponents&&global.resizeComponents();g.leaveTryBlock(3);break;case 4:f=g.enterCatchBlock(),console.error(f);case 3:global.annotationPannel.noteEvent(c.noteAdd),g.jumpToEnd()}})});b.append(this.noteAdd)},
...
removeMiniFullScreen:function(){if(this.miniFullScreen&&!this.miniFullscreenEnter){var b={alpha:.5};$(b).animate({alpha:0},{duration:300,easing:"easeOutSine",step:function(){this.miniFullScreen&&this.miniFullScreen.css({opacity:b.alpha})}.bind(this),complete:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen&&(this.miniFullScreen=void 0)}.bind(this)})}},onResize:function(){if(this.miniFullScreen)if(MiniStyle.isMini())this.miniFullScreen.remove(),this.miniFullScreen=void 0;
else{var b=BookInfo.top();this.miniFullScreen.css({top:b+BookInfo.height()-40+"px"})}},show:function(){this.miniFullScreen&&this.miniFullScreen.show()},hide:function(){this.miniFullScreen&&this.miniFullScreen.hide()},remove:function(){this.miniFullScreen&&this.miniFullScreen.remove();this.miniFullScreen=void 0},setStyle:function(b){b&&this.miniFullScreen&&this.miniFullScreen.css(b)}}),BookAttachmentsFactory=Class({create:function(b,c,d,e){this.isDoublePage=e;this.container=b;this.book=d;this.pageIndex=
c},createAttachment:function(b,c){switch(b){case "thickness":var d=c?new ThicknessManager(this.container,this.book):new SingleBookThicknessManager(this.container,this.book);d.refreshThickness();break;case "bookshadow":d=new BookShadow(this.container);break;case "zoomhint":d=new ZoomHint(this.parent);break;case "minifullscreen":d=new BookMiniFullscreen;0<=BookInfo.getCurrentPages().indexOf(1)&&d.init();break;case "bookpagenumber":d=new BookPageNumberForFlip;break;case "staticad":d=new StaticAd(this.container);
break;case "zoommap":d=new ZoomMap(this.book);d.fillContent(this.pageIndex);break;case "bookmarktab":d=new BookmarkTab(this.container,!this.isDoublePage);break;case "noteadd":d=new NoteAdd(this.container)}return d}}),BookAttachmentsBuilder=Class({Package:"BookAttachment",create:function(b,c,d,e){this.parent=b;this.pageIndex=c;this.book=d;this.isDoublePage=e;this.Items=this.createAttachmentsForBook()},createAttachmentsForBook:function(){var b=new ObjectPool;this.factory=new BookAttachmentsFactory(this.parent,
this.pageIndex,this.book,this.isDoublePage);return b},thickness:function(b){this.bookThickness=this.factory.createAttachment("thickness",b);this.Items.add(this.bookThickness)},bookshadow:function(){this.bookShadow=this.factory.createAttachment("bookshadow");this.Items.add(this.bookShadow)},grayshadow:function(){_agent_.browser.msie||_agent_.browser.safari||!bookConfig.ShowTopLeftShadow||this.book.bookType!=BookType.normal_book||(this.grayshadow=this.factory.createAttachment("grayshadow"),this.Items.add(this.grayshadow))},
miniFullscreen:function(){this.miniFullscreen=this.factory.createAttachment("minifullscreen");this.Items.add(this.miniFullscreen)},bookpagenumber:function(){this.bookPageNumber=this.factory.createAttachment("bookpagenumber");this.bookPageNumber.init();this.Items.add(this.bookPageNumber)},staticad:function(){void 0!=global.staticAd&&1==staticAd.haveAd&&(this.staticAd=this.factory.createAttachment("staticad"),this.Items.add(this.staticAd))},zoommap:function(){isPad()||isPhone()||!bookConfig.ZoomMapVisible||
(this.zoomMap=this.factory.createAttachment("zoommap"),this.Items.add(this.zoomMap))},bookmarktab:function(){(function(){isPhone()||isPad()||(this.bookMarkTab=this.factory.createAttachment("bookmarktab"),this.Items.add(this.bookMarkTab))}).delay(this,1)},noteadd:function(){!bookConfig.AnnotationButtonVisible||isPhone()||isPad()||(this.noteAdd=this.factory.createAttachment("noteadd"),this.Items.add(this.noteAdd))},zoomhint:function(){isTouchDevice()},hide:function(){this.Items.find("StaticAd").each(function(b){b.hide()});
...
h=b.coordinate.y,k,l=this.flippingTime;l=l*Math.abs(b.toPoint.x-g)/Math.abs(b.toPoint.x-b.startPoint.x);e=isAndroidWeChat()||isAndroidDefault()||isIE()||isFirefox()?function(){var q=0;k=function(){m(q,25,"Sine");q++}.interval(this,l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,x){if(!b)return!1;var t=b.pageWidth,r=b.pageHeight,u=$.easing["easeInOut"+x],y=$.easing["easeOut"+x];x=y(null,q,g,b.toPoint.x-g,p);y=y(null,q,h,b.toPoint.y-h,p);
b.dragMoveToFlip||(x=u(null,q,g,b.toPoint.x-g,p),y=bookConfig.FlipDirection?f*Math.sqrt(r*r-x*x):r-f*Math.sqrt(t*t-x*x));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:y}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,d),BookEvent.trigger("afterFlipPage",[d]),k.stop())}.bind(this);e()}},setFlipInterval:function(){this.flipInterval=function(){if(!this.flipIntervalManager.flipInterval||!this.flipIntervalManager.flipInterval.stop){if(this.flipPageManager&&this.flipPageManager.array&&
...
l/25)}.bind(this):function(){k=function(q,p){m(q,p,"Sine")}.animation(this,l)}.bind(this);var m=function(q,p,x){if(!b)return!1;var t=b.pageWidth,r=b.pageHeight,u=$.easing["easeInOut"+x],y=$.easing["easeOut"+x];x=y(null,q,g,b.toPoint.x-g,p);y=y(null,q,h,b.toPoint.y-h,p);b.dragMoveToFlip||(x=u(null,q,g,b.toPoint.x-g,p),y=bookConfig.FlipDirection?f*Math.sqrt(r*r-x*x):r-f*Math.sqrt(t*t-x*x));q<p?this.flipToPoint(b,c,d,b.fromPoint,{x:x,y:y}):(this.flipToPoint(b,c,d,b.fromPoint,b.toPoint),this.book.afterFlipTo(b,
...
d=void 0,x=transformCSS({scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})):(d=void 0,x=transformCSS({origin:g,scale:{x:m,y:q},perspective:6E3,rotateY:null!=(d=p.rotateY)?d:0})));p.setCSSByStyle(x);if(p.page.pageFlipShadow){var t=h?transformCSS({scale:{x:k.x/m,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});p.page.pageFlipShadow&&p.page.pageFlipShadow.setCSSByStyle(t)}}}return{x:m,y:q}}catch(r){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,
...
this.pageBackArray[d].page.side.addClass("boxShadow"));return[this.pageArray[d],this.pageBackArray[d]]},getMovedXByIndex:function(b){var c=this.getSpace(),d=this.getFitWHByIndex(b);b=parseInt(d[0].x+d[1].x);d=parseInt(d[0].y);return{x:(windowWidth-c.left-c.right-b)/2+c.left,y:(windowHeight-c.top-c.bottom-d)/2+c.top}},scalePages:function(b,c,d,e,f,g,h,k,l){var m=this;try{var q=1,p=1;q=$.easing.easeInOutSine(null,c,1,f.x/e.x-1,d);p=$.easing.easeInOutSine(null,c,1,f.y/e.y-1,d);c=function(t){if(t){var r=
transformCSS({tran:l?l:{x:0,y:0},scale:{x:q,y:p},origin:g});if(m.isCoverPage(t.pageIndex))if(t.tran=l?l:{x:0,y:0},t.scale={x:q,y:p},t.rotateY){t.$page[0].style.removeProperty("transform-origin");var u;r=transformCSS({scale:{x:q,y:p},perspective:6E3,rotateY:null!=(u=t.rotateY)?u:0})}else{var y;r=transformCSS({origin:g,scale:{x:q,y:p},perspective:6E3,rotateY:null!=(y=t.rotateY)?y:0})}t.setCSSByStyle(r);r=h?transformCSS({scale:{x:k.x/q,y:1},origin:g}):transformCSS({scale:{x:1,y:1},origin:g});t.page.pageFlipShadow&&
t.page.pageFlipShadow.setCSSByStyle(r)}};for(d=0;d<b.length;d++){var x=this.pageBackArray[b[d]];c(this.pageArray[b[d]]);c(x)}return{x:q,y:p}}catch(t){}},getTranScaleByIndex:function(b){return this.getFitWHByIndex(b)},getFitWHByIndex:function(b,c,d){this.getSpace(!1);var e=this.getSpace(!0);c||(c=windowWidth-e.left-e.right);d||(d=windowHeight-e.top-e.bottom);e=[];b=[b];for(var f=0;f<b.length;f++)b[f]?e.push(window.pageList&&pageList[b[f]-1]?pageList[b[f]-1]:{width:bookConfig.largePageWidth,height:bookConfig.largePageHeight}):
...
(function(b){function c(h,k){h=h.querySelectorAll("canvas");var l=k.querySelectorAll("canvas"),m=[];h.forEach(function(q,p){var x=l[p];if(x){x.width=q.width;x.height=q.height;q=q.toDataURL();var t=new Image;p=new Promise(function(r){t.onload=function(){x.getContext("2d").drawImage(t,0,0);r()};t.onerror=function(){return r()}});t.src=q;m.push(p)}});return Promise.all(m).then(function(){})}var d=0,e={mode:"iframe",standard:"html5",popHt:500,popWd:400,popX:200,popY:200,popTitle:"",popClose:!1,extraCss:"",
extraHead:"",retainAttr:["id","class","style"],onReady:null},f={};b.fn.printArea=function(h){b.extend(f,e,h);d++;b("[id^=printArea_]").remove();f.id="printArea_"+d;var k=b(this),l=g.getPrintWindow();g.write(l.doc,k);c(b(this)[0],l.doc).then(function(){function m(){p&&p();g.print(l)}var q=b(l.doc).find("img"),p=h&&"function"===typeof h.onReady?h.onReady:null;if(0===q.length)m();else{var x=0;q.each(function(t,r){if(r.complete)x++,x===q.length&&m();else b(r).on("load error",function(){x++;x===q.length&&
