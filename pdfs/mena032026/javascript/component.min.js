...
f.callWhenSettled_(h.resolve,h.reject)};e.prototype.settleSameAsThenable_=function(f,h){var k=this.createResolveAndReject_();try{f.call(h,k.resolve,k.reject)}catch(l){k.reject(l)}};e.prototype.then=function(f,h){function k(p,q){return"function"==typeof p?function(t){try{l(p(t))}catch(r){m(r)}}:q}var l,m,n=new e(function(p,q){l=p;m=q});this.callWhenSettled_(k(f,l),k(h,m));return n};e.prototype.catch=function(f){return this.then(void 0,f)};e.prototype.callWhenSettled_=function(f,h){function k(){switch(l.state_){case 1:f(l.result_);
...
b){b=void 0===b?{}:b;this.printArea=$("<div class='print-area' style='width:100%;height:100%;position:absolute;left:0;top:0;'></div>");this.button=a;this.parent=b.parent||tmpContainer;this.options=b;this.initPrintEvent()},getImageSizeForMM:function(a,b){return a/210>=b/297?{width:210,height:Math.floor(210*b/a)}:{width:Math.floor(297*a/b),height:297}},getImageSizeForInches:function(a,b){return a/7.18>=b/10.61?{width:7.18,height:Number.fixed(7.18*b/a,2)}:{width:Number.fixed(10.61*a/b,2),height:10.61}},
getImageSizeForIE:function(a,b){return a/8>=b/11.3?{width:8,height:Number.fixed(8*b/a,2)}:{width:Number.fixed(11.3*a/b,2),height:11.3}},printPages:function(a){var b=this,c,d,e,g,f,h;return $jscomp.asyncExecutePromiseGeneratorProgram(function(k){if(!a||!a.length||!parseBool(bookConfig.PrintButtonVisible))return k.return();b.initLoadPrint();c=0;b.printArea.empty();b.printArray=[];d=function(l,m,n,p){var q=this,t,r,x,u,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(w){switch(w.nextAddress){case 1:return t=
$("<div style='position:relative;width:100%;height:100%;'></div>"),r=$(n),l&&-1<l.indexOf("none")&&!l.startsWith("data:image")&&m&&0>m.indexOf("none")&&(r=$(m)),void 0===p&&(p=n),w.setCatchFinallyBlocks(2),w.yield(q.createCompositeImage(r,l),4);case 4:(x=w.yieldResult)&&(r=$(x));w.leaveTryBlock(3);break;case 2:u=w.enterCatchBlock(),console.error("Canvas\u935a\u581f\u579a\u6fb6\u8fab\u89e6:",u);case 3:t.append(r);$(r).parent().css({"text-align":"center",width:"100%",height:"100%"});r.css({"text-align":"center",
"max-width":"100%","max-height":"100%"});"stretch"===bookConfig.printBackgroundPosition?r.css({width:"100%",height:"100%"}):"fill"===bookConfig.printBackgroundPosition?r.css({width:"100%",height:"100%","object-fit":"cover"}):$(r).parent().css({display:"flex","justify-content":"center","align-items":"center"});q.printArray[p]=t;c++;if(c==a.length){for(v=0;v<q.printArray.length;v++)q.printArray[v]&&q.printArea.append(q.printArray[v]);q.printArea.printArea({onReady:q.hidePrintLoading.bind(q)})}w.jumpToEnd()}})};
e=BookInfo.getBook().pageWidth;g=BookInfo.getBook().pageHeight;f={};for(h=0;h<a.length;f={$jscomp$loop$prop$page$4:f.$jscomp$loop$prop$page$4},h++)f.$jscomp$loop$prop$page$4=a[h],getPageDir(f.$jscomp$loop$prop$page$4,"normal").then(function(l){return function(m){var n=e,p=g;if(bookConfig.normalSuffix&&"zip"===bookConfig.normalSuffix||-1<m.indexOf("zip"))window.printLoadStack||b.initPrintStack(a),n=2*e,p=2*g;"object"!=typeof m&&m.match(/none/)?b.getPrintImgType(l.$jscomp$loop$prop$page$4).then(function(q){pageResourceLoad(l.$jscomp$loop$prop$page$4,
q,d.bind(b),n,p)}):pageResourceLoad(l.$jscomp$loop$prop$page$4,"normal",d.bind(b),n,p)}}(f));k.jumpToEnd()})},createCompositeImage:function(a,b){var c=this;return new Promise(function(d,e){try{var g=document.createElement("canvas"),f=g.getContext("2d"),h=new Image;h.crossOrigin="anonymous";h.onload=function(){var k,l,m,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==p.nextAddress)return p.setCatchFinallyBlocks(2),g.width=h.naturalWidth,g.height=h.naturalHeight,f.drawImage(h,
0,0),p.yield(c.createWatermarkWithPageWatermark(h.naturalWidth,h.naturalHeight),4);if(2!=p.nextAddress)return(k=p.yieldResult)?f.drawImage(k,0,0):console.log("watermarkCanvas error"),l=g.toDataURL("image/png"),m=document.createElement("img"),m.src=l,m.style.cssText=a[0].style.cssText,d(m),p.leaveTryBlock(0);n=p.enterCatchBlock();console.error("canvas error:",n);d(null);p.jumpToEnd()})};h.onerror=function(){console.log("img.onerror:",b);d(null)};h.src=b}catch(k){console.log("createCompositeImage error:",
k),d(null)}})},createWatermarkWithPageWatermark:function(a,b){return new Promise(function(c){if(parseBool(bookConfig.PrintButtonVisible)&&bookConfig.printWatermark)try{var d=document.createElement("canvas");d.width=a;d.height=b;var e=new WatermarkCore(d),g=BookInfo.getBook().pageWidth,f=BookInfo.getBook().pageHeight,h=Math.min(a/g,b/f),k={position:bookConfig.watermarkPosition,width:(bookConfig.watermarkWidth||100)*h,height:(bookConfig.watermarkHeight||50)*h,opacity:bookConfig.watermarkOpacity,spacing:(bookConfig.watermarkSpacing||
50)*h,rotation:bookConfig.watermarkRotation,watermarkEdgeMargin:(bookConfig.watermarkEdgeMargin||12)*h,watermarkImage:new Image};if(bookConfig.printWatermarkFile){if(k.watermarkImage.src=bookConfig.printWatermarkFile,k.watermarkImage.onload=function(){try{bookConfig.watermarkHeight||(k.height=k.width*k.watermarkImage.height/k.watermarkImage.width),e.applyWatermark(k),c(d)}catch(l){console.error("\u59d8\u6751\u5d43\u6434\u65c2\u6564\u6fb6\u8fab\u89e6:",l),c(null)}},k.watermarkImage.complete)try{bookConfig.watermarkHeight||
(k.height=k.width*k.watermarkImage.height/k.watermarkImage.width),e.applyWatermark(k),c(d)}catch(l){console.error("\u59d8\u6751\u5d43\u6434\u65c2\u6564\u6fb6\u8fab\u89e6:",l),c(null)}}else c(null)}catch(l){console.error("\u9352\u6d98\u7f13\u59d8\u6751\u5d43canvas\u6fb6\u8fab\u89e6:",l),c(null)}else c(null)})},getPrintImgType:function(a){var b,c,d;return $jscomp.asyncExecutePromiseGeneratorProgram(function(e){if(1==e.nextAddress)return b="normal",e.yield(getPageDir(a,"thumb"),2);if(3!=e.nextAddress)return c=
e.yieldResult,e.yield(getPageDir(a,"previewPage"),3);d=e.yieldResult;c.match(/none/)?d.match(/none/)||(b="previewPage"):b="thumb";return e.return(b)})},getPages:function(a){if("all"==a){a=[];for(var b=1;b<=bookConfig.totalPageCount;b++)a.push(b);return a}return"current"==a?this.options.getCurrentPages?this.options.getCurrentPages():BookInfo.getCurrentPages():getPagesByRange(a)},initPrintEvent:function(){this.button.bind(_event._click,function(a){this.printType=this.button.printType;switch(this.printType){case "printAll":var b=
this.getPages("all");this.printPages(b);break;case "printCurrent":b=this.getPages("current");this.printPages(b);break;case "printRange":var c=$("#print_range_num").val();if(0>=parseInt(c))return;b=this.getPages(c);this.printPages(b)}if("printAll"===this.printType){var d="print_all_pages";var e="all pages"}else"printCurrent"===this.printType?(d="print_page_"+b.join("_"),e=b.join("_")):"printRange"===this.printType&&(a=c.replace(/,/g,"_"),d="print_page_"+a,e=a);BookEvent.trigger("customEvent",[d,{printed_page:e}]);
BookEvent.trigger("print",[BookInfo.getCurrentPageIndex(),"printAll"==this.printType?"all":b.join(","),this.printType])}.bind(this))},initPrintStack:function(a){window.printLoadStack&&(window.printLoadStack.destroy(),window.printLoadStack=null);window.printLoadStack||(window.printLoadStack=new PdfLoadArray(a.length))},initLoadPrint:function(){this.printLoad||(this.printLoad=$("<div class='posterContainer'></div>"),this.printLoad.css({display:"none","z-index":"10001",position:"absolute",left:"0",top:"0",
width:"100%",height:"100%",background:"rgba(11,11,11,0.7)"}),this.printLoad.bind("click",function(a){a.stopPropagation();window.printLoadStack&&window.printLoadStack.destroy();this.hidePrintLoading()}.bind(this)),this.loadingIcon=$("<img style='position:absolute;transform : translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);left : 50%;top : 50%;z-index:1112' src='"+uiBaseURL+"loading.gif' />"),this.printLoad.append(this.loadingIcon),this.parent.append(this.printLoad));this.showPrintLoading()},
showPrintLoading:function(){this.printLoad&&this.printLoad.fadeIn(200)},hidePrintLoading:function(){this.printLoad&&this.printLoad.fadeOut(200)}}),PrintElements=Class({create:function(a){this._super(a);this.printOnUrl=form_icons.print_on?"data:image/png;base64,"+form_icons.print_on:uiBaseURL+"print_on.png";this.printOffUrl=form_icons.print_off?"data:image/png;base64,"+form_icons.print_off:uiBaseURL+"print_off.png";this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){this.rightToLeft?
(this.printAll=$("<div class='printAll item button' print='printAll'><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span><img src='"+this.printOffUrl+"'/></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span><img src='"+this.printOnUrl+"'/></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><input id='print_range_num' dir='rtl' placeholder='"+
getLanguage("frmPrintexample","Exzample:1,3-7,12")+"'></input><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><img src='"+this.printOffUrl+"'/></div>")):(this.printAll=$("<div class='printAll item button' print='printAll'><img src='"+this.printOffUrl+"'/><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><img src='"+this.printOnUrl+"'/><span class='title'>"+
getLanguage("frmPrintcurrent","Print Current Pages")+"</span></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><img src='"+this.printOffUrl+"'/><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><input id='print_range_num' placeholder='"+getLanguage("frmPrintexample","Example:1,3-7,12")+"'></input></div>"));this.printButton=$("<div class='printButton title button'>"+getLanguage("frmPrintbtn","Print")+"</div>");this.printButton.printType="printCurrent";
...
this.printRange.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printRange.find("input").on("input propertychange change",function(){this.refreshPrintButton()}.bind(this));this.printRange.find("input").bind("mousedown touchstart pointerdown mouseover mousemove touchmove touchstend",function(b){b.stopPropagation()})},buttonEvent:function(a,b){var c=a.stage.find(".on");c.find("img").attr("src",this.printOffUrl);c.find("img")[0].colorChanged=!1;c.removeClass("on");$(b).find("img").attr("src",
this.printOnUrl);$(b).find("img")[0].colorChanged=!1;$(b).addClass("on");b=$(b).attr("print");a.printButton.printType=b;this.refreshPrintButton();a.changeItemColor()},refreshPrintButton:function(){"printRange"!=this.printButton.printType||$("#print_range_num").val()?this.lightPrintButton():this.darkPrintButton()},lightPrintButton:function(){$(this.printButton).addClass("usable");$(this.printButton).removeClass("disable");$(this.printButton).addClass("button_hover")},darkPrintButton:function(){"printRange"==
this.printButton.printType&&($(this.printButton).removeClass("usable"),$(this.printButton).removeClass("button_hover"),$(this.printButton).addClass("disable"))},changeLanguage:function(){this.printAll.find(".title").html(getLanguage("frmPrintall","Print All Pages"));this.printCurrent.find(".title").html(getLanguage("frmPrintcurrent","Print Current Pages"));this.printRange.find(".title").html(getLanguage("frmPrintRange","Print Range"));this.printRange.find("#print_range_num").attr("placeholder",getLanguage("frmPrintexample",
"Exzample:1,3-7,12"));this.printButton.html(getLanguage("frmPrintbtn","Print"))}}).extend(FormElements),PhonePrintElements=Class({create:function(a){this._super(a);this.printOnUrl=phoneBaseURL+"print_on_phone.png";this.printOffUrl=phoneBaseURL+"print_off_phone.png";this.fontColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){this.rightToLeft?(this.printAll=$("<div class='printAll item button' print='printAll'><span class='title'>"+
getLanguage("frmPrintall","Print All Pages")+"</span><div class='print_icon'>"+this.getOffIcon()+"</div></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><span class='title'>"+getLanguage("frmPrintcurrent","Print Current Pages")+"</span><div class='print_icon'>"+this.getOnIcon()+"</div></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><div class='print_icon'>"+this.getOffIcon()+"</div><input id='print_range_num' dir='rtl' placeholder='"+
getLanguage("frmPrintexample","Exzample:1,3-7,12")+"'></input><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span></div>")):(this.printAll=$("<div class='printAll item button' print='printAll'><div class='print_icon'>"+this.getOffIcon()+"</div><span class='title'>"+getLanguage("frmPrintall","Print All Pages")+"</span></div>"),this.printCurrent=$("<div class='printCurrent item on button' print='printCurrent'><div class='print_icon'>"+this.getOnIcon()+"</div><span class='title'>"+
getLanguage("frmPrintcurrent","Print Current Pages")+"</span></div>"),this.printRange=$("<div class='printRange item button' print='printRange'><div class='print_icon'>"+this.getOffIcon()+"</div><span class='title'>"+getLanguage("frmPrintRange","Print Range")+"</span><input id='print_range_num' placeholder='"+getLanguage("frmPrintexample","Example:1,3-7,12")+"'></input></div>"));this.printButton=$("<div class='printButton title button' role='button'>"+getLanguage("frmPrintbtn","Print")+"</div>");
...
"page"+b+".png")}),f._pdfLoadingTask.start(),u.return();if(-1<k.indexOf(".js"))return pageResourceLoad(b,"normal",function(v){f._createAndTriggerDownload(v,"page"+b+".png")}),u.return();"downloadCurrent"===a&&isSupportWebp&&!bookConfig.isEncryptionBook&&(k=k.removeStartFrom("?"),-1<k.indexOf("webp")&&(k+="?x-oss-process=image/format,jpg"));if(k.match(/^none/))return n=document.createElement("canvas"),p=n.getContext("2d"),n.width=bookConfig.largePageWidth,n.height=bookConfig.largePageWidth,p.fillStyle=
bookConfig.pageBackgroundColor,p.fillRect(0,0,bookConfig.largePageWidth,bookConfig.largePageHeight),f._createAndTriggerDownload(n.toDataURL("image/png"),"page"+b+".png"),u.return();q="";"downloadCurrent"===a&&(q=b+".jpg");"downloadAttachments"===a&&(q=c||"");if(location.protocol.match("file:"))return/^\/\//i.test(k)&&(k="https://"+k),"English"==UserGroups&&"downloadAll"==a&&(t=window.location.href,k=k.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(t))),window.open(k),u.return();if("downloadAll"===
...
window.htmlConfig.phoneTemplate.path&&(b=window.htmlConfig.phoneTemplate.path,c="_phone.svg")}catch(d){console.warn("Failed to get phone logo path:",d)}return b+a.replace(".svg",c)},refreshList:function(){this.url=Metacharacter(share_url);this.title=Metacharacter(share_title);this.screenshot=Metacharacter(share_screenshot);this.description=Metacharacter(share_description);this.shareList=window.shareObj&&0<window.shareObj.length?this.initShareList():this.initDefaultShareList()},initShareList:function(){if(!window.shareObj||
0>=window.shareObj.length)return[];for(var a=window.shareObj.length,b=[],c=0;c<a;c++){var d=window.shareObj[c];if("mobile"!=d.filter||isPC())if("pc"!=d.filter||!isPC()||d.specail)d=this.fixItemInfo(d),b.push(d)}return b},fixItemInfo:function(a){if(a){var b=share_url,c="",d="";try{c=window.parent.location.href,d=window.top.location.href}catch(h){}var e=window.document.title,g=share_screenshot;a.name&&"facebook"==a.name.toLowerCase()&&(g=facebook_screenshot);var f=a.url+"";0<=f.indexOf("${url_no_page}")&&
(f=f.remove("${url_no_page}"),b=b.removeStartFrom("#p="),c=c.removeStartFrom("#p="),d=d.removeStartFrom("#p="));f=f.replaceAll("${url}",b,!0);f=f.replaceAll("${url_no_page}",b,!0);f=f.replaceAll("${url_parent}",c,!0);f=f.replaceAll("${url_top}",d,!0);"baidutieba"==a.type?(b=g.replace("https","http"),f=f.replaceAll("${shot-img}",b,!0)):f=f.replaceAll("${shot-img}",g,!0);f=f.replaceAll("${title}",e,!0);share_description||(f=f.replace("&desc=${description}",""),f=f.replace("&text=${description}",""));
e=this.getLogoPath(a.logo+"");b=a.title+"";c=a.popUp;return a.name&&"facebook"==a.name.toLowerCase()?{logo:e,url:"javascript:ShareToFaceBook({url:share_url, title:share_title, screenshot:facebook_screenshot, description:share_description})",title:b,type:a.type}:"qrcode"==a.name?{url:"javascript:openQRCode()",logo:e,title:b,type:a.type}:c?{url:"javascript:openPopUp("+c+")",logo:e,title:b}:"qqShare"==a.type&&(isPhone()||isPad())?{url:"javascript:sharePhoneQQ()",logo:e,title:b,type:a.type}:"poster"==
a.type?{url:"javascript:showPoster()",type:"poster",logo:e,title:b}:"copy"==a.type?{url:"",type:"copy",logo:e,title:b}:{url:f,logo:e,title:b,type:a.type}}},initDefaultShareList:function(){var a=[{logo:this.getLogoPath(isBelowIE9()?"facebook.png":"facebook.svg"),url:"javascript:ShareToFaceBook({url:share_url, title:share_title, screenshot:facebook_screenshot, description:share_description})",title:"Facebook",name:"facebook",type:"facebook"},{logo:this.getLogoPath(isBelowIE9()?"twitter.png":"twitter.svg"),
url:"https://twitter.com/intent/tweet?url="+this.url+"&text="+this.title,title:"Twitter",name:"twitter",type:"twitter"},{logo:this.getLogoPath("instagram.svg"),url:"javascript:ShareToInstagram()",title:"Instagram",name:"instagram",type:"instagram"},{logo:this.getLogoPath("pinterest.svg"),url:"https://www.pinterest.com/pin/create/button/?url="+this.url,title:"Pinterest",name:"pinterest",type:"pinterest"},{logo:this.getLogoPath("whatsapp.svg"),url:"https://wa.me/?text="+this.url,title:"WhatsApp",name:"whatsapp",
...
b,c).then(d).catch(e)}.bind(this)).catch(e)}.bind(this)).catch(e)}.bind(this)).catch(e)}.bind(this))},renderPdfPageToCanvas:function(a,b,c){return new Promise(function(d,e){try{var g=document.createElement("canvas"),f=g.getContext("2d"),h=window.devicePixelRatio||1,k=a.getViewport({scale:1}),l=fitPageWidthHeight(b||k.width,c||k.height,k.width,k.height).x/k.width;k=a.getViewport({scale:l});var m=k.width,n=k.height;g.width=m*h;g.height=n*h;g.style.width=m+"px";g.style.height=n+"px";a.render({canvasContext:f,
...
a.linkArea.val(),0<=b.toLowerCase().indexOf("file:")&&(b="index.html"),c="<iframe frameborder='0'  width='240' height='210'  title='"+window.document.title+"' src='"+b+"' type='text/html' allowfullscreen='true' scrolling='no' marginwidth='0' marginheight='0'></iframe>",a.insertArea&&a.insertArea.val(c),share_url=b,a.analysisShare.refreshList(),k.yield(a.analysisShare.getList(),2);d=k.yieldResult;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$10:e.$jscomp$loop$prop$type$10},g++)f=a.itemArray[g],
e.$jscomp$loop$prop$type$10=f.attr("data-type"),(h=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$10}}(e)))&&(-1<h.url.indexOf("javascript")?f.attr("onclick",h.url.remove("javascript:")+";return false;"):f.attr("href",h.url));k.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=a.val(),copyToClipboard(a)}}},changeLanguage:function(){this.copy1.html(getLanguage("lblCopy","Copy"))},initColorConfig:function(){this.mainColor=
