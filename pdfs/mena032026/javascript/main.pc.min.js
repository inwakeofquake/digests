...
n.on("panstart panmove panend",function(p){p.srcEvent.preventDefault();switch(p.type){case "panstart":p="function"===typeof e?e():a;if(0<(p?p.scrollTop:0))break;m=!0;break;case "panmove":if(m){if(p.deltaY>g){m=!1;k=!0;b.style.transition="none";var q=b.offsetHeight;l=q;b.style.height=q+"px";b.style.maxHeight="100vh";b.style.transform="translateY("+p.deltaY+"px)"}else p.deltaY<-g&&(m=!1);break}k&&0<p.deltaY&&(b.style.transform="translateY("+p.deltaY+"px)");break;case "panend":if(m)m=!1;else if(k)if(k=
!1,b.style.transition="transform "+h+"ms ease, height "+h+"ms ease",0<p.deltaY)if(p.deltaY>f&&"function"===typeof c.onClose)c.onClose();else d();else d()}});return function(){n.off("panstart panmove panend");n.destroy();$(a).removeAttr("style");$(b).removeAttr("style")}}
...
title:"",showTitle:!1,titleClass:"",closeButton:!1,closeButtonClass:"",onCloseButton:null,customButtons:null,closeOnPullDownAtTop:!1,scrollContainer:null,commitThreshold:10};this.options=$.extend({},this.defaults,a);this.isOpen=!1;this._contentPullDownCleanup=null;Array.isArray(DrawerPanel._instances)||(DrawerPanel._instances=[]);DrawerPanel._instances.push(this);this.initElements();this.initEvents();this.initStyles()};
...
""))})};
DrawerPanel.prototype.open=function(){var a=this;if(!this.isOpen){Array.isArray(DrawerPanel._instances)&&DrawerPanel._instances.slice().forEach(function(c){c!==a&&c.isOpen&&"function"===typeof c.close&&c.close()});this.isOpen=!0;this.$drawer.css({visibility:"visible",opacity:0});try{this.$drawer[0]&&this.$drawer[0].offsetHeight}catch(c){}var b=function(){a.$drawer[0]&&a.$drawer[0].style&&(a.$drawer[0].style.height="",a.$drawer[0].style.maxHeight="");a.$drawer.css({transform:"translateY(0)",height:"auto",
maxHeight:a.options.maxHeight,minHeight:a.options.minHeight,borderTopLeftRadius:a.options.topRadius+"px",borderTopRightRadius:a.options.topRadius+"px",opacity:1,boxShadow:"0 -2px 10px rgba(0, 0, 0, 0.2)"})};window.requestAnimationFrame?requestAnimationFrame(b):setTimeout(b,0);"function"===typeof this.options.onOpen&&this.options.onOpen.call(this)}};
...
"flex-shrink":0});a.chatBotBtnTips.find(".close-icon").css({"box-sizing":"border-box",width:"10px",height:"10px",cursor:"pointer","flex-shrink":0});a.setBtnSize();a.handleBtnDrag({$el:a.chatBotBtn[0],parent:a.parent,callback:function(){a.beforeShow()}});a.chatBotBtn.on("keydown",function(d){if("Enter"===d.key||13===d.keyCode)d.preventDefault(),BookEvent.trigger("customEvent",["click_chatbot_button"]),a.beforeShow(d)});c.jumpToEnd()})},setBtnSize:function(){var a=this,b=bookConfig.chatBotButtonIconHeight;
this.chatBotBtn.css({"z-index":"98",position:"absolute",bottom:"80px",right:"50px","box-sizing":"border-box",height:b+"px",border:0,background:"transparent",borderRadius:"50%",overflow:"hidden"});this.chatBotBtn.find("img").css({"box-sizing":"border-box",width:"100%",height:"100%",pointerEvents:"none"});var c=this.chatBotBtn.find("img")[0];c.complete?this.chatBotBtn.css({width:c.naturalWidth*b/c.naturalHeight+"px"}):(c.addEventListener("load",function(){a.chatBotBtn.css({width:c.naturalWidth*b/c.naturalHeight+
"px"})}),c.onerror=function(){console.log("iconImg onerror")})},showChatBotBtnTips:function(){var a=this,b=this.chatBotBtn[0].getBoundingClientRect();this.parent.append(this.chatBotBtnTips);this.chatBotBtnTips.fadeIn();this.isChatBotBtnTipsVisible=!0;this.chatBotBtnTips.css({display:"flex","box-sizing":"border-box",position:"absolute",bottom:window.innerHeight-b.bottom+"px",right:window.innerWidth-b.left+8+"px",cursor:"pointer"});this.chatBotBtnTips[0].addEventListener("click",function(c){c.target===
...
getPopupTipsVisible:function(){var a=getHashParams("chatbotVisible"),b=GetQueryString("chatbot");if(b&&"1"==b||a&&"true"==a)return!1;try{var c=window.localStorage.getItem("isChatbotPopupTipsVisible");return c?JSON.parse(c):!0}catch(d){}},setPopupTipsVisible:function(a){try{window.localStorage.setItem("isChatbotPopupTipsVisible",a)}catch(b){}},handleBoxDrag:function(a){function b(m){this.isDraging=!0;var l=g.getBoundingClientRect();m=m.center;h=m.x-l.x;k=m.y-l.y;$(e).css({cursor:"move",width:"100%",
height:"100%"})}function c(m){if(this.isDraging){var l=m.center;m=f.width();var n=f.height(),p=$(g).outerWidth(),q=$(g).outerHeight(),r=l.x-h;l=l.y-k;r=Math.min(m-p,Math.max(0,r));l=Math.min(n-q,Math.max(0,l));$(g).css({bottom:"initial",right:"initial",left:r+"px",top:l+"px"})}}function d(){this.isDraging=!1;$(e).css({cursor:"pointer",width:"80%",height:"50px"})}var e=a.$ele,f=a.parent,g=a.$box;a=new Hammer(e);a.add(new Hammer.Pan({threshold:0,pointers:0}));var h=0,k=0;a.on("panstart panmove panend",
function(m){m.preventDefault();switch(m.type){case "panstart":b(m);break;case "panmove":c(m);break;case "panend":d(m)}})},beforeShow:function(a){this.hidePopupTips();BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"chatbot","chatbot button"]);this.showOrHide()},isRtl:function(){var a,b,c=/^(hebrew|arabic)$/.test(null==(a=selectedLanguage)?void 0:null==(b=a.language)?void 0:b.toLowerCase());return bookConfig.RightToLeft||c},initHtml:function(){var a=this;this.container=$('<div class="chatbot-container"></div>');
this.chatbotBox=$('<div id="chatbotBox" class="chatbot-box"></div>');this.chatbotDrag=$('<div id="draggableBox" class="chatbot-drag"></div>');this.chatbotResize=$('<div id="resizableBox" class="chatbot-resize"></div>');this.resizeLeft=$('<div class="chatbot-resize-item chatbot-resize-left"></div>');this.resizeRight=$('<div class="chatbot-resize-item chatbot-resize-right"></div>');this.resizeTop=$('<div class="chatbot-resize-item chatbot-resize-top"></div>');this.resizeBottom=$('<div class="chatbot-resize-item chatbot-resize-bottom"></div>');
this.resizeMask=$('<div class="chatbot-resize-mask"></div>');var b=_get(window,"website_domian_wc","https://fliphtml5.com"),c=removeUrlParts(window.location.href);bookConfig.socialShareLink&&(c=bookConfig.socialShareLink);var d=getMetaTagValueByName("description"),e=getMetaTagValueByName("keywords");b+="/chatbot/chatbot.php";c=Metacharacter(c);e=Metacharacter(e);d=Metacharacter(d);var f=this.isRtl()?"1":"0",g,h,k=(null==(g=selectedLanguage)?void 0:null==(h=g.language)?void 0:h.toLowerCase())||"english";
this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' src='"+(b+"?url="+c+"&desc="+d+"&keyword="+e+"&isRtl="+f+"&lang="+k)+"' ></iframe>");this.frame.on("load",function(){a.onLoadIframe()});this.container.append(this.chatbotBox);this.container.append(this.chatBotBtn);this.parent.append(this.container);this.chatbotBox.css({"box-sizing":"border-box","z-index":9999,position:"absolute",right:"120px",bottom:"50px",width:"421px",height:"740px",opacity:0,visibility:"hidden",
"border-radius":"12px"});this.chatbotResize.append(this.frame);this.chatbotResize.append(this.resizeLeft);this.chatbotResize.append(this.resizeRight);this.chatbotResize.append(this.resizeTop);this.chatbotResize.append(this.resizeBottom);this.chatbotResize.append(this.resizeMask);this.chatbotBox.append(this.chatbotDrag);this.chatbotBox.append(this.chatbotResize);this.initResizeCss();this.chatbotDrag.css({width:"80%",left:"50%",transform:"translateX(-50%)"})},initEvent:function(){var a=this;window.addEventListener("message",
...
{shownPages:c},b)}));break;case "getRealPageNumber":b.shownPages&&0<b.shownPages.length&&(c=b.shownPages.map(function(e){return getRealPageNumber(e)}),a.postMessage({eventName:"setRealPageNumber",type:"chatBot",data:Object.assign({},{realPages:c},b)}));break;case "showAuthorization":a.showAuthorization()}});this.handleResize()},showAuthorization:function(){function a(){window.encryptionPannel&&window.encryptionPannel.isEncryptionBook&&window.encryptionPannel.show()}BookRestrict.isLoaded?a():BookEvent.bindEvent("onLoadBookRestrict",
function(b,c){c&&a()})},setPrompt:function(a){var b=this;a=void 0===a.greeting?"":a.greeting;var c=this.chatBotBtnTips.find(".chatbot-btn-beckon");c&&c.empty().text(a);this.getPopupTipsVisible()&&(a=this.chatBotBtn.find("img")[0],a.complete?this.showChatBotBtnTips():a.addEventListener("load",function(){b.showChatBotBtnTips()}))},handleResize:function(){function a(l,n){function p(u){this.isResizing=!0;g=u.center.x;h=u.center.y;k=c.width();m=c.height();switch(n){case "right":c.css({right:"initial",
left:u.center.x-k+"px"});break;case "left":c.css({right:"initial",left:u.center.x+"px"});break;case "top":c.css({bottom:"initial",top:u.center.y+"px"});break;case "bottom":c.css({bottom:"initial",top:u.center.y-m+"px"})}$(l).css({cursor:"move"});d.css({display:"block"});b.frame.css({"box-shadow":"none",border:"none"})}function q(u){if(this.isResizing){var x=Math.min(u.center.x-g,e),v=Math.min(u.center.y-h,f);if(!(u.center.x>e||u.center.y>f||0>u.center.x||0>u.center.y))switch(n){case "right":c.css({width:k+
x+"px"});break;case "left":c.css({left:u.center.x+"px",width:k-x+"px"});break;case "top":c.css({top:u.center.y+"px",height:m-v+"px"});break;case "bottom":c.css({height:m+v+"px"})}}}function r(){this.isResizing=!1;"left"!=n&&"right"!=n||$(l).css({cursor:"ew-resize"});"top"!=n&&"bottom"!=n||$(l).css({cursor:"ns-resize"});d.css({display:"none"});b.frame.css({"box-shadow":"0 0 20px 0 rgba(0, 0, 0, 0.1)",border:"1px solid rgba(0,0,0,0.1)"})}var t=new Hammer(l);t.add(new Hammer.Pan({threshold:0,pointers:0}));
t.on("panstart panmove panend",function(u){u.preventDefault();switch(u.type){case "panstart":p(u);break;case "panmove":q(u);break;case "panend":r(u)}})}document.querySelectorAll(".chatbot-resize-item").forEach(function(l){var n=l.classList[1].split("-")[2];a(l,n)});var b=this,c=this.chatbotBox,d=this.resizeMask,e=this.parent.width(),f=this.parent.height(),g=0,h=0,k=0,m=0},initResizeCss:function(){this.resizeMask.css({display:"none",position:"absolute",left:0,top:0,right:0,bottom:0,"z-index":1E3});
this.resizeLeft.css({position:"absolute",left:0,top:0,bottom:0,width:"5px",height:"100%",cursor:"ew-resize","z-index":1E3});this.resizeRight.css({position:"absolute",right:0,top:0,bottom:0,width:"5px",height:"100%",cursor:"ew-resize","z-index":1E3});this.resizeTop.css({position:"absolute",left:0,top:0,right:0,height:"5px",width:"100%",cursor:"ns-resize","z-index":1E3});this.resizeBottom.css({position:"absolute",left:0,bottom:0,right:0,width:"100%",height:"5px",cursor:"ns-resize","z-index":1E3})},
showOrHide:function(){this.visible?this.hide():this.show()},show:function(){var a=this;this.visible||(this.visible=!0,this.chatbotBox.css({opacity:1,visibility:"visible"}),this.handleBoxDrag({$ele:this.chatbotDrag[0],parent:this.parent,$box:this.chatbotBox[0]}),this.postMessage({messageType:"show"}),setTimeout(function(){a.focusIframe()},100),FormManager.register(this))},onLoadIframe:function(){var a=this,b=function(){var c=bookConfig.isEncryptionBook&&!BookRestrict.getRestrictToken(),d=BookRestrict.getRestrictToken(),
e=a.getProtectedType();console.log("setProtected",{isProtected:c,token:d,protectedType:e});a.postMessage({eventName:"setProtected",type:"chatBot",data:{isProtected:c,token:d,protectedType:e}})};bookConfig.isEncryptionBook?BookRestrict.isLoaded?(console.log("BookRestrict.isLoaded",BookRestrict.isLoaded),b()):BookEvent.bindEvent("onLoadBookRestrict",function(c,d){console.log("onLoadBookRestrict",d);d&&b()}):this.postMessage({eventName:"setProtected",type:"chatBot",data:{isProtected:!1,token:"",protectedType:""}})},
getProtectedType:function(){var a,b=null==(a=window.encryptionPannel)?void 0:a.type;return{0:"password",1:"email",7:"purchase"}[void 0!==b&&null!==b?String(Number(b)):void 0]||""},hide:function(){var a=this;this.visible&&(this.visible=!1,this.chatbotBox.css({opacity:0,visibility:"hidden"}),this.postMessage({messageType:"hide"}),this.blurIframe(),setTimeout(function(){a.chatBotBtn.focus()},100),FormManager.unregister(this))},setRestrictToken:function(a,b){b&&this.postMessage({eventName:"setRestrictToken",
type:"chatBot",data:{token:b}})},postMessage:function(a){var b=document.querySelector("#chatbotIframe");b&&b.contentWindow.postMessage(a,"*")},focusIframe:function(){try{this.frame[0].focus()}catch(a){console.log("\u8bbe\u7f6eiframe\u7126\u70b9\u5931\u8d25:",a)}},blurIframe:function(){try{this.frame[0].blur()}catch(a){console.log("\u79fb\u9664iframe\u7126\u70b9\u5931\u8d25:",a)}},handleIframeReady:function(){var a=this;this.visible&&setTimeout(function(){a.focusIframe()},100)},onResize:function(a,
...
Class("ModernChatbot",{create:function(a){this.parent=a;this.visible=!1;this.initChatBotBtn();this.initHtml();this.initEvent();BookEvent.bindEvent("setRestrictToken",this.setRestrictToken.bind(this))},initChatBotBtn:function(){var a=this,b,c;return $jscomp.asyncExecutePromiseGeneratorProgram(function(d){if(1==d.nextAddress)return b=bookConfig.chatBotButtonIcon||uiBaseURL+"chatbot.png",a.chatBotBtn=$("<div id='chatbotBtn' class='chatbot-btn'>\n    <img src='"+b+"'/>\n    </div>"),a.chatBotBtnTips=
$("<div class='chatbot-btn-tips'>\n        <div class='chatbot-btn-beckon'>\n          <img class='beckon-icon' src='"+uiBaseURL+"beckon.png'/>\n          <span>"+getLanguage("chatbotBtnTips","Hi~ Ask me about the book, or anything!")+"</span>\n        </div>\n        <img class='close-icon' src='"+uiBaseURL+"close-icon.png'/>\n    </div>"),a.chatBotBtnTips.css({display:"none","box-sizing":"border-box","z-index":98,padding:"10px",height:"initial",textAlign:"center",background:"#fff",borderRadius:"16px",
"font-size":"16px",color:"#333","font-weight":"400","justify-content":"space-between","align-items":"center","box-shadow":"0px 4px 4px 0px rgba(0, 0, 0, 0.1)",gap:"8px","font-family":"Calibri,Helvetica,sans-serif","max-width":"100%"}),a.chatBotBtnTips.find(".beckon-icon").css({"box-sizing":"border-box",width:"18px",height:"21px",verticalAlign:"middle","flex-shrink":0}),a.chatBotBtnTips.find(".close-icon").css({"box-sizing":"border-box",width:"10px",height:"10px",cursor:"pointer","flex-shrink":0}),
d.yield(a.setBtnSize(),2);(c=a.getPopupTipsVisible())&&setTimeout(function(){a.showChatBotBtnTips()},100);a.handleBtnDrag({$el:a.chatBotBtn[0],parent:a.parent,callback:a.handleShow.bind(a)});a.parent.append(a.chatBotBtn);d.jumpToEnd()})},setBtnSize:function(){var a=this,b=bookConfig.chatBotButtonIconHeight;this.chatBotBtn.css({"z-index":"98",position:"absolute",bottom:_get(window.userInfo,"c",1)?"180px":"150px",right:"50px","box-sizing":"border-box",height:b+"px",border:0,background:"transparent",
borderRadius:"50%",overflow:"hidden"});this.chatBotBtn.find("img").css({"box-sizing":"border-box",width:"100%",height:"100%"});return new Promise(function(c){var d=a.chatBotBtn.find("img")[0];d.addEventListener("load",function(){a.chatBotBtn.css({width:d.naturalWidth*b/d.naturalHeight+"px"});c()})})},showChatBotBtnTips:function(){var a=this,b=this.chatBotBtn[0].getBoundingClientRect();this.parent.append(this.chatBotBtnTips);this.chatBotBtnTips.fadeIn();this.isChatBotBtnTipsVisible=!0;this.chatBotBtnTips.css({display:"flex",
"box-sizing":"border-box",position:"absolute",width:Math.min(window.innerWidth-b.width-50-10,.6*window.innerWidth)+"px",bottom:window.innerHeight-b.bottom+"px",right:window.innerWidth-b.left+8+"px",cursor:"pointer"});this.chatBotBtnTips[0].addEventListener("click",function(c){c.stopPropagation();c.target===a.chatBotBtnTips.find(".close-icon")[0]?(a.hidePopupTips(),BookEvent.trigger("clickButton",[BookInfo.getCurrentPageIndex(),"chatbot","close chatBot tips"])):a.handleShow()})},handleBtnDrag:function(a){function b(n){this.isDraging=
!0;m=e.getBoundingClientRect();n=n.center;h=n.x-m.x;k=n.y-m.y;$(e).css({cursor:"move"})}function c(n){if(this.isDraging){var p=n.center;n=f.width();var q=f.height(),r=e,t=$(r).outerWidth(),u=$(r).outerHeight();r=l.isChatBotBtnTipsVisible?p.x-h:p.x-t/2;p=l.isChatBotBtnTipsVisible?p.y-k:p.y-u/2;r=Math.min(n-t,Math.max(0,r));p=Math.min(q-u,Math.max(0,p));$(e).css({left:r+"px",top:p+"px",right:"initial",bottom:"initial"});l.chatBotBtnTips[0]&&(n=l.chatBotBtnTips[0].getBoundingClientRect(),l.chatBotBtnTips.css({left:r-
n.width-8+"px",right:"initial",bottom:window.innerHeight-p-m.height+"px"}))}}function d(){this.isDraging=!1;$(e).css({cursor:"pointer"})}var e=a.$el,f=a.parent,g=a.callback;a=new Hammer(e);a.add(new Hammer.Pan({threshold:0,pointers:0}));var h=0,k=0,m,l=this;a.on("panstart panmove panend",function(n){n.preventDefault();switch(n.type){case "panstart":b(n);break;case "panmove":c(n);break;case "panend":d(n)}});a.on("tap",function(n){n.preventDefault();g&&g(n)})},hidePopupTips:function(){this.chatBotBtnTips&&
...
[BookInfo.getCurrentPageIndex(),"chatbot","chatbot button"]);this.showOrHide()},isRtl:function(){var a,b,c=/^(hebrew|arabic)$/.test(null==(a=selectedLanguage)?void 0:null==(b=a.language)?void 0:b.toLowerCase());return bookConfig.RightToLeft||c},initHtml:function(){var a=this;this.chatbotBox=$('<div id="chatbotBox" class="chatbot-box"></div>');var b=_get(window,"website_domian_wc","https://fliphtml5.com"),c=removeUrlParts("https://online.fliphtml5.com/oldfh/bqhu/#p=1");bookConfig.socialShareLink&&
(c=bookConfig.socialShareLink);var d=getMetaTagValueByName("description"),e=getMetaTagValueByName("keywords");b+="/chatbot/chatbot.php";c=Metacharacter(c);e=Metacharacter(e);d=Metacharacter(d);var f=this.isRtl()?"1":"0",g,h,k=(null==(g=selectedLanguage)?void 0:null==(h=g.language)?void 0:h.toLowerCase())||"english";this.frame=$("<iframe id='chatbotIframe' allow=\"microphone\" class='chatbot-frame' border='0' width='100%' height='100%' src='"+(b+"?url="+c+"&desc="+d+"&keyword="+e+"&isRtl="+f+"&lang="+
k)+"' ></iframe>");this.frame.on("load",function(){a.onLoadIframe()});this.chatbotBox.append(this.frame);this.content=$('<div class="modern-chatbot-drawer-content"></div>');this.content.append(this.chatbotBox);this.drawer=global.createDrawerPanel({container:$(tmpContainer),content:this.content,dragBar:!1,dragToClose:!1,showCancelButton:!1,showConfirmButton:!1,topRadius:20,backdrop:!0,backdropClose:!0,closeOnPullDownAtTop:!0,scrollContainer:".modern-chatbot-drawer-content",zIndex:99999,onOpen:function(){a.visible=
!0},onClose:function(){a.visible=!1}})},initEvent:function(){var a=this;window.addEventListener("message",function(b){var c=(null==b?void 0:b.data)||{},d=void 0===c.eventName?"":c.eventName;b=void 0===c.data?{}:c.data;if("chatbot"===(void 0===c.type?"":c.type).toLowerCase())switch(d){case "close":a.hide();break;case "changePage":b.page&&(gotoPageFun(b.page),a.hide());break;case "inputFocus":window.disableResize=!0;break;case "inputBlur":window.disableResize=!1;break;case "getShownPageNumber":b.realPages&&
...
!0,this.drawer&&this.drawer.open(),this.postMessage({messageType:"show"}))},hide:function(){this.visible&&(this.visible=!1,this.drawer&&this.drawer.close(),this.postMessage({messageType:"hide"}),window.disableResize=!1)},showOrHide:function(){this.visible?this.hide():this.show()},getProtectedType:function(){var a,b=null==(a=window.encryptionPannel)?void 0:a.type;return{0:"password",1:"email",7:"purchase"}[void 0!==b&&null!==b?String(Number(b)):void 0]||""},showAuthorization:function(){function a(){window.encryptionPannel&&
window.encryptionPannel.isEncryptionBook&&window.encryptionPannel.show()}BookRestrict.isLoaded?a():BookEvent.bindEvent("onLoadBookRestrict",function(b,c){c&&a()})},setRestrictToken:function(a,b){b&&this.postMessage({eventName:"setRestrictToken",type:"chatBot",data:{token:b}})},postMessage:function(a){var b=document.querySelector("#chatbotIframe");b&&b.contentWindow.postMessage(a,"*")},changeLanguage:function(a){this.chatBotBtnTips&&this.chatBotBtnTips.find("span").text(getLanguage("chatbotBtnTips",
"Hi~ Ask about the book, or anything!"));this.postMessage({eventName:"changeLang",type:"chatBot",data:{lang:a}})},onResize:function(a,b){if(this.drawer&&"function"===typeof this.drawer.onResize)this.drawer.onResize()}});
