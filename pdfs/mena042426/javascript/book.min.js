...
b+"?2024081201' type='audio/ogg'>\n      <source src='"+c+"?2024081201' type='audio/mpeg'>\n      </audio>");$("body").append(flipAudio)}},initSettingBody=function(){(isPhone()||isPad())&&"neat"===_get(htmlConfig,"phoneTemplate.name")&&"Chinese"==UserGroups?global.toolBar&&global.toolBar.$morePanel&&global.toolBar.$morePanel.appendMusicButton&&global.toolBar.$morePanel.appendMusicButton():global.settingBody?global.settingBody.reset&&global.settingBody.reset():isPhone()||isPad()?global.settingBody=
...
getConfigValue("power_info","");tmpBookConfig.power_info&&"string"===typeof tmpBookConfig.power_info&&(tmpBookConfig.power_info=JSON.parse(tmpBookConfig.power_info));tmpBookConfig.PageModeButtonVisible=getConfigValue("PageModeButtonVisible",!1);tmpBookConfig.isAnnotationCustomIconEnabled=getConfigValue("isAnnotationCustomIconEnabled",!1);tmpBookConfig.annotationStickerButtonIcon=getConfigValue("annotationStickerButtonIcon","");tmpBookConfig.annotationAddTextButtonIcon=getConfigValue("annotationAddTextButtonIcon",
"");tmpBookConfig.annotationSelectTextButtonIcon=getConfigValue("annotationSelectTextButtonIcon","");tmpBookConfig.annotationBrushButtonIcon=getConfigValue("annotationBrushButtonIcon","");tmpBookConfig.annotationHighlighterButtonIcon=getConfigValue("annotationHighlighterButtonIcon","");tmpBookConfig.annotationRectangleButtonIcon=getConfigValue("annotationRectangleButtonIcon","");tmpBookConfig.annotationEllipseButtonIcon=getConfigValue("annotationEllipseButtonIcon","");tmpBookConfig.annotationEraserButtonIcon=
getConfigValue("annotationEraserButtonIcon","");tmpBookConfig.annotationClearButtonIcon=getConfigValue("annotationClearButtonIcon","");tmpBookConfig.annotationUndoButtonIcon=getConfigValue("annotationUndoButtonIcon","");tmpBookConfig.annotationRedoButtonIcon=getConfigValue("annotationRedoButtonIcon","");tmpBookConfig.annotationSaveButtonIcon=getConfigValue("annotationSaveButtonIcon","");tmpBookConfig.annotationExitButtonIcon=getConfigValue("annotationExitButtonIcon","");tmpBookConfig.isShowBottomFullscreenPrompts=
getConfigValue("isShowBottomFullscreenPrompts",!0);tmpBookConfig.isMobileFirstLastShortcutVisible=getConfigValue("isMobileFirstLastShortcutVisible",void 0);void 0!==tmpBookConfig.isMobileFirstLastShortcutVisible&&(tmpBookConfig.isMobileFirstLastShortcutVisible=parseBool(tmpBookConfig.isMobileFirstLastShortcutVisible));tmpBookConfig.isMobilePageBackButtonVisible=getConfigValue("isMobilePageBackButtonVisible",!1);tmpBookConfig.enableDomainAccess=getConfigValue("enableDomainAccess",!0);tmpBookConfig.domainAccess=
getConfigValue("domainAccess","").toLowerCase();tmpBookConfig.isSearchFormNailUpEnabled=getConfigValue("isSearchFormNailUpEnabled","Chinese"==UserGroups?!1:!0);tmpBookConfig.showWatermark=getConfigValue("showWatermark",!1);tmpBookConfig.printWatermark=getConfigValue("printWatermark",!0);tmpBookConfig.watermarkRotation=getConfigValue("watermarkRotation",0);tmpBookConfig.watermarkSpacing=getConfigValue("watermarkSpacing",20);tmpBookConfig.watermarkOpacity=getConfigValue("watermarkOpacity",.4);tmpBookConfig.watermarkPosition=
getConfigValue("watermarkPosition","Center").toLowerCase();tmpBookConfig.watermarkWidth=getConfigValue("watermarkWidth",100);tmpBookConfig.watermarkHeight=getConfigValue("watermarkHeight",0);tmpBookConfig.watermarkEdgeMargin=getConfigValue("watermarkEdgeMargin",12);tmpBookConfig.flipShortcutButtonColor=getConfigValue("flipShortcutButtonColor","");tmpBookConfig.flipShortcutButtonHoverColor=getConfigValue("flipShortcutButtonHoverColor","");tmpBookConfig.flipShortcutButtonBackgroundColor=getConfigValue("flipShortcutButtonBackgroundColor",
"");tmpBookConfig.flipShortcutButtonHoverBackgroundColor=getConfigValue("flipShortcutButtonHoverBackgroundColor","");tmpBookConfig.printOptions=getConfigValue("printOptions","all,current,range").toLowerCase();tmpBookConfig.isBookDomainAccessEnabled=getConfigValue("isBookDomainAccessEnabled",!0);tmpBookConfig.isZoomControlBarVisible=getConfigValue("isZoomControlBarVisible",!0);tmpBookConfig.autoFlipPageOnTimelineEnd=getConfigValue("autoFlipPageOnTimelineEnd",!1);tmpBookConfig.homeButtonOpenWindowType=
getConfigValue("homeButtonOpenWindowType","Chinese"==UserGroups?"_self":"_blank").toLowerCase();tmpBookConfig.homeButtonOpenWindowType.startsWith("_")||(tmpBookConfig.homeButtonOpenWindowType="_"+tmpBookConfig.homeButtonOpenWindowType);tmpBookConfig.isFirstLastShortcutVisible=getConfigValue("isFirstLastShortcutVisible",void 0);void 0!==tmpBookConfig.isFirstLastShortcutVisible&&(tmpBookConfig.isFirstLastShortcutVisible=parseBool(tmpBookConfig.isFirstLastShortcutVisible));tmpBookConfig.miniFullscreenDisplayType=
getConfigValue("miniFullscreenDisplayType","always").toLowerCase();tmpBookConfig.isFakeStopBook=getConfigValue("isFakeStopBook",0);tmpBookConfig.isTabelOfContentSearchBarVisible=getConfigValue("isTabelOfContentSearchBarVisible",!0);tmpBookConfig.mouseDragFlip=getConfigValue("mouseDragFlip",!0);tmpBookConfig.disablePrintShortcut=getConfigValue("disablePrintShortcut",!1);tmpBookConfig.chatBotButtonIconHeight=getConfigValue("chatBotButtonIconHeight",48);tmpBookConfig.chatBotButtonIcon=getConfigValue("chatBotButtonIcon",
...
var VERSION_NAME="7.0.0",BUILD_DATE="2026042301",BookType={normal_book:0,single_book:1,slide_book:3,singleSlide_book:6,catalog_book:7,singleCatalog_book:8,documentView_book:9,singleDocumentView_book:10,card_book:11,invert_book:12},normalBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},singleBookStatu={book_statu_ready:0,book_statu_auto_flip:1,book_statu_mouse_flip:2,book_statu_mag_flip:3},bookCorner={top_left:0,top_right:1,bottom_left:2,bottom_right:3},
...
window.getWidth(),windowHeight=c=window.getHeight(),windowWidth=b,e.yield(checkFliphtml5PagesConfig(),2);case 2:return e.yield(checkBookConfig(),3);case 3:return selectLanguage(bookConfig.language),e.yield(validateDomainAccess(),4);case 4:d=e.yieldResult;if(!d)return e.return();initImageBaseUrl();global.onBookLoad=new LoadingBook(tmpContainer,bookConfig.loadingBackground);if("article4"===global.templeteName){e.jumpTo(5);break}return e.yield(initToolBarBrand(),5);case 5:delayLoading();var f=document.getElementById("aria-page-title-header");
