...
PhoneDownloadButton:"PhoneDownloadForm",PhoneLanguageButton:"PhoneLanguageForm",PhoneAboutButton:"PhoneAboutForm",PhoneTableOfContentButton:"PhoneTableOfContentForm",PhoneShareButton:"PhoneShareForm",PhoneNumberButton:"TelephoneNumberForm",PhoneVideoButton:"PhoneVideoGalleryForm",PhoneSlideshowButton:"PhotoGallery"};
...
d+"/mobile/index.html"+(window.location.search+window.location.hash);return}}$("body").empty();$("body").attr("style","");$("body").css({display:"flex","flex-direction":"column","align-items":"center","justify-content":"center",background:"#ffffff",color:"#000000","text-align":"center","font-size":"20px"});$("body").append("<img alt='' style='width:98px;height:98px;' src='"+uiBaseURL+"only-wechat.svg'/><p style='margin-top:35px;'>\u5185\u5bb9\u4e0d\u5b58\u5728</p>");return}}catch(e){}}if(bookConfig.OnlyOpenInWechat||
