...
"box-sizing":"border-box",height:b+"px",border:0,background:"transparent",borderRadius:"50%",overflow:"hidden"});this.chatBotBtn.find("img").css({"box-sizing":"border-box",width:"100%",height:"100%",pointerEvents:"none"});var c=this.chatBotBtn.find("img")[0];(null==c?0:c.complete)?this.chatBotBtn.css({width:c.naturalWidth*b/c.naturalHeight+"px"}):(c.addEventListener("load",function(){a.chatBotBtn.css({width:c.naturalWidth*b/c.naturalHeight+"px"})}),c.onerror=function(){console.log("iconImg onerror")})},
...
c._textSectionTaskId)return g.return();d=c.getPageTextByIndex(a-1);return g.yield(c.getReaderTextByIndex(a-1),2)}e=g.yieldResult;if(b!==c._textSectionTaskId)return g.return();f=Array.isArray(e)?0<e.length:!!e;if(!d&&!f)return g.return();d&&b===c._textSectionTaskId&&c.appendPlainParagraph(d);Array.isArray(e)?e.forEach(function(h){b===c._textSectionTaskId&&c.appendHtmlParagraph(h)}):e&&b===c._textSectionTaskId&&c.appendHtmlParagraph(e);g.jumpToEnd()})},_createAccessParagraph:function(){var a=this,b=
document.createElement("p");b.setAttribute("tabindex","0");b.setAttribute("aria-live","polite");b.setAttribute("aria-atomic","true");b.setAttribute("role","region");b.addEventListener("focus",function(){a.textSection[0].scrollTop=b.offsetTop});return b},appendPlainParagraph:function(a){var b=this._createAccessParagraph();b.textContent=a;this.textSection[0].appendChild(b)},appendHtmlParagraph:function(a){var b=this._createAccessParagraph();b.innerHTML=a;this.textSection[0].appendChild(b)}});
